...
<span class="home"></span><br><br>
				...
				<p><span class="style10">SPEAKER ABSTRACTS </span><br><br><br>
				  ...
				  <strong><span class="style17">Simone Spuler, MD</span><br>

				  </strong><em>Muscle Research Unit, Charit&eacute;  University Medicine Berlin,  Experimental and Clinical Research    Center, Berlin, Germany</em>&nbsp;&nbsp;<strong><br>

                  </strong> <span class="style10"><br>

                  <img src="images/conference/31-Spuler.jpg" width="135">                  <br>

                  <br>

                  <br>

                  </span><strong>Complement-inhibition in dysferlin-deficient  muscular dystrophy</strong><br>

                  <br>

                  Complement  inhibitory factor CD55 is downregulated in skeletal muscle in LGMD2B. This has  been shown in patients, and in three dysferlin-deficient mouse models, SJL/J,  A/J and Dysf -/-. The consequences of lacking CD55 are activation of  C5b9 membrane attack complex (MAC) on non-necrotic muscle fibers and increased  susceptibility to cell death after exposure to complement. We took three  different approaches to test our hypothesis that complement-inhibition is  beneficial in dysferlin-deficient muscular dystrophy: 1. Because intravenous  immunoglobulins (IVIG) have complement-inhibitory properties, three patients  with dysferlin-deficient muscular dystrophy were treated with IVIG for a total  of five treatment episodes lasting 6 months each. Quality of life  questionnaire, muscle strength and muscle histology were compared before and  after treatment. All three patients reported benefits. Muscle strength and  muscle histology improved in two patients. 2. We evaluated the effect of  monoclonal anti-murine-complement factor C5

antibody (gift from Alexion Pharmaceuticals)  in dysferlin-deficient SJL/J mice (n=54). Muscle histology revealed a highly  significant reduction in the number of necrotic fibers in anti-C5 treated  animals, compared to albumin- or non-treated controls. 3. Muscle histology and  muscle strength of SJL/J mice were compared to A/J mice at different  timepoints. A/J mice lack complement factor C5. Muscle weakness and  histological abnormalities develop later in A/J mice than in SJL/J. All three  approaches support the hypothesis that complement inhibition alleviates  dysferlin-deficient muscular dystrophy. A controlled clinical trial is  justified.</p>
