...
$sql=	"UPDATE registrants SET " .
  ...
  //echo $sql;
	...
	?><script language="javascript">window.location="form3dutch.php";</script><?
...
onMouseOut="window.document.sq8.src='images/button_faq.gif'"><img src="images/button_faq.gif" border="0" name="sq8" alt="FAQ on LGMD2B/Miyoshi" width="168" height="32"></a></td>
            ...
            <td valign="top" align="center">
				  ...
				  <form name="registrant_2" method="post" action="form2dutch.php" onSubmit="validate();">
...
<strong><font color="#990000">DEEL 2: FAMILIE ACHTERGROND</font></strong> (optioneel)<br>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        ...
                        <td bgcolor="#F3F9FA"><p class="form2"><strong>Heeft een van de ouders de ziekte?</strong><strong><br>

                          Moeder</strong>

                            <input type="radio" name="mom_disease" value="Yes">Ja 

						  &nbsp;&nbsp;<input type="radio" name="mom_disease" value="No">Nee 

                          &nbsp;&nbsp;<br>

                          <strong>Vader</strong>

                          <input type="radio" name="dad_disease" value="Yes">Ja 

						  &nbsp;&nbsp;<input type="radio" name="dad_disease" value="No">Nee 
					  ...
					  <tr>
                        ...
                        <td><p class="form2"><strong>Zijn er broers en/of  zussen van dezelfde ouders?</strong><br>

                          Naam <input name="sibling_name1" type="text" size="18">

                          &nbsp;&nbsp;Leeftijd <input name="sibling_age1" type="text" size="3">

                          &nbsp;&nbsp;Heeft ook LGMD2B? <input type="radio" name="sibling_LGMD2B1" value="Yes">Ja

						  &nbsp;&nbsp;<input type="radio" name="sibling_LGMD2B1" value="No">Nee<br>

						 Naam <input name="sibling_name2" type="text" size="18">

                          &nbsp;&nbsp;Leeftijd <input name="sibling_age2" type="text" size="3">

                          &nbsp;&nbsp;Heeft ook LGMD2B? <input type="radio" name="sibling_LGMD2B2" value="Yes">Ja

						  &nbsp;&nbsp;<input type="radio" name="sibling_LGMD2B2" value="No">Nee<br>

							   Naam <input name="sibling_name3" type="text" size="18">

                          &nbsp;&nbsp;Leeftijd <input name="sibling_age3" type="text" size="3">

                          &nbsp;&nbsp;Heeft ook LGMD2B? <input type="radio" name="sibling_LGMD2B3" value="Yes">Ja

						  &nbsp;&nbsp;<input type="radio" name="sibling_LGMD2B3" value="No">Nee<br>

						  Naam <input name="sibling_name4" type="text" size="18">

                          &nbsp;&nbsp;Leeftijd <input name="sibling_age4" type="text" size="3">

                          &nbsp;&nbsp;Heeft ook LGMD2B? <input type="radio" name="sibling_LGMD2B4" value="Yes">Ja

						  &nbsp;&nbsp;<input type="radio" name="sibling_LGMD2B4" value="No">Nee
					  ...
					  <tr>
                        ...
                        <td bgcolor="#F3F9FA"><p class="form2"><strong>Heeft u kinderen?</strong><br>

                          Naam <input name="children_name1" type="text" size="18">

                          &nbsp;&nbsp;Leeftijd <input name="children_age1" type="text" size="3">

                          &nbsp;&nbsp;Heeft ook LGMD2B? <input type="radio" name="children_LGMD2B1" value="Yes">Ja

						  &nbsp;&nbsp;<input type="radio" name="children_LGMD2B1" value="No">Nee<br>

						 Naam <input name="children_name2" type="text" size="18">

                          &nbsp;&nbsp;Leeftijd <input name="children_age2" type="text" size="3">

                          &nbsp;&nbsp;Heeft ook LGMD2B? <input type="radio" name="children_LGMD2B2" value="Yes">Ja

						  &nbsp;&nbsp;<input type="radio" name="children_LGMD2B2" value="No">Nee<br>

							   Naam <input name="children_name3" type="text" size="18">

                          &nbsp;&nbsp;Leeftijd <input name="children_age3" type="text" size="3">

                          &nbsp;&nbsp;Heeft ook LGMD2B? <input type="radio" name="children_LGMD2B3" value="Yes">Ja

						  &nbsp;&nbsp;<input type="radio" name="children_LGMD2B3" value="No">Nee<br>

						  Naam <input name="children_name4" type="text" size="18">

                          &nbsp;&nbsp;Leeftijd <input name="children_age4" type="text" size="3">

                          &nbsp;&nbsp;Heeft ook LGMD2B? <input type="radio" name="children_LGMD2B4" value="Yes">Ja

						  &nbsp;&nbsp;<input type="radio" name="children_LGMD2B4" value="No">Nee
					  ...
					  <tr>
                        ...
                        <td><p class="form2"><strong>Heeft iemand anders in de familie deze ziekte?</strong><br>

                          Naam <input name="relatives_name1" type="text" size="18">

                          &nbsp;&nbsp;Leeftijd <input name="relatives_age1" type="text" size="3">

                          &nbsp;&nbsp;Heeft ook LGMD2B? <input type="radio" name="relatives_LGMD2B1" value="Yes">Ja

						  &nbsp;&nbsp;<input type="radio" name="relatives_LGMD2B1" value="No">Nee<br>

						 Naam <input name="relatives_name2" type="text" size="18">

                          &nbsp;&nbsp;Leeftijd <input name="relatives_age2" type="text" size="3">

                          &nbsp;&nbsp;Heeft ook LGMD2B? <input type="radio" name="relatives_LGMD2B2" value="Yes">Ja

						  &nbsp;&nbsp;<input type="radio" name="relatives_LGMD2B2" value="No">Nee<br>

							   Naam <input name="relatives_name3" type="text" size="18">

                          &nbsp;&nbsp;Leeftijd <input name="relatives_age3" type="text" size="3">

                          &nbsp;&nbsp;Heeft ook LGMD2B? <input type="radio" name="relatives_LGMD2B3" value="Yes">Ja

						  &nbsp;&nbsp;<input type="radio" name="relatives_LGMD2B3" value="No">Nee<br>

						  Naam <input name="relatives_name4" type="text" size="18">

                          &nbsp;&nbsp;Leeftijd <input name="relatives_age4" type="text" size="3">

                          &nbsp;&nbsp;Heeft ook LGMD2B? <input type="radio" name="relatives_LGMD2B4" value="Yes">Ja

						  &nbsp;&nbsp;<input type="radio" name="relatives_LGMD2B4" value="No">Nee
