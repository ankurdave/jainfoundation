...
$sql=	"UPDATE registrants SET " .
  ...
  //echo $sql;
	...
	?><script language="javascript">window.location="form3.php";</script><?
...
onMouseOut="window.document.sq8.src='images/button_faq.gif'"><img src="images/button_faq.gif" border="0" name="sq8" alt="FAQ on LGMD2B/Miyoshi" width="168" height="32"></a></td>
            ...
            <td valign="top" align="center">
				  ...
				  <form name="registrant_2" method="post" action="form2.php" onSubmit="validate();">
              ...
              <tr>
                ...
                <td valign="top"><p class="section">Patient Registration</p>
                    ...
                    <p class="home"> <strong><font color="#0175C2">Registration
                      ...
                      <strong>ALL OF YOUR INFORMATION

                      WILL BE KEPT CONFIDENTIAL.</strong><br>

<br>

<strong><font color="#990000">PART 2: FAMILY BACKGROUND</font></strong> (optional)<br>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        ...
                        <td bgcolor="#F3F9FA"><p class="form2"><strong>Do either of your parents

                              have the disease?</strong><strong><br>

                          Mother</strong>

                            <input type="radio" name="mom_disease" value="Yes">Yes 

						  &nbsp;&nbsp;<input type="radio" name="mom_disease" value="No">No 

                          &nbsp;&nbsp;<br>

                          <strong>Father</strong>

                          <input type="radio" name="dad_disease" value="Yes">Yes 

						  &nbsp;&nbsp;<input type="radio" name="dad_disease" value="No">No 
					  ...
					  <tr>
                        ...
                        <td><p class="form2"><strong>Do you
                              ...
                              have any siblings from the same two parents?</strong><br>

                          Name <input name="sibling_name1" type="text" size="18">

                          &nbsp;&nbsp;Age <input name="sibling_age1" type="text" size="3">

                          &nbsp;&nbsp;Also affected with LGMD2B? <input type="radio" name="sibling_LGMD2B1" value="Yes">Yes

						  &nbsp;&nbsp;<input type="radio" name="sibling_LGMD2B1" value="No">No<br>

						 Name <input name="sibling_name2" type="text" size="18">

                          &nbsp;&nbsp;Age <input name="sibling_age2" type="text" size="3">

                          &nbsp;&nbsp;Also affected with LGMD2B? <input type="radio" name="sibling_LGMD2B2" value="Yes">Yes

						  &nbsp;&nbsp;<input type="radio" name="sibling_LGMD2B2" value="No">No<br>

							   Name <input name="sibling_name3" type="text" size="18">

                          &nbsp;&nbsp;Age <input name="sibling_age3" type="text" size="3">

                          &nbsp;&nbsp;Also affected with LGMD2B? <input type="radio" name="sibling_LGMD2B3" value="Yes">Yes

						  &nbsp;&nbsp;<input type="radio" name="sibling_LGMD2B3" value="No">No<br>

						  Name <input name="sibling_name4" type="text" size="18">

                          &nbsp;&nbsp;Age <input name="sibling_age4" type="text" size="3">

                          &nbsp;&nbsp;Also affected with LGMD2B? <input type="radio" name="sibling_LGMD2B4" value="Yes">Yes

						  &nbsp;&nbsp;<input type="radio" name="sibling_LGMD2B4" value="No">No
					  ...
					  <tr>
                        ...
                        <td bgcolor="#F3F9FA"><p class="form2"><strong>Do you

                              have any children?</strong><br>

                          Name <input name="children_name1" type="text" size="18">

                          &nbsp;&nbsp;Age <input name="children_age1" type="text" size="3">

                          &nbsp;&nbsp;Also affected with LGMD2B? <input type="radio" name="children_LGMD2B1" value="Yes">Yes

						  &nbsp;&nbsp;<input type="radio" name="children_LGMD2B1" value="No">No<br>

						 Name <input name="children_name2" type="text" size="18">

                          &nbsp;&nbsp;Age <input name="children_age2" type="text" size="3">

                          &nbsp;&nbsp;Also affected with LGMD2B? <input type="radio" name="children_LGMD2B2" value="Yes">Yes

						  &nbsp;&nbsp;<input type="radio" name="children_LGMD2B2" value="No">No<br>

							   Name <input name="children_name3" type="text" size="18">

                          &nbsp;&nbsp;Age <input name="children_age3" type="text" size="3">

                          &nbsp;&nbsp;Also affected with LGMD2B? <input type="radio" name="children_LGMD2B3" value="Yes">Yes

						  &nbsp;&nbsp;<input type="radio" name="children_LGMD2B3" value="No">No<br>

						  Name <input name="children_name4" type="text" size="18">

                          &nbsp;&nbsp;Age <input name="children_age4" type="text" size="3">

                          &nbsp;&nbsp;Also affected with LGMD2B? <input type="radio" name="children_LGMD2B4" value="Yes">Yes

						  &nbsp;&nbsp;<input type="radio" name="children_LGMD2B4" value="No">No
					  ...
					  <tr>
                        ...
                        <td><p class="form2"><strong>Do any

                              of your other relatives/ancestors have the disease?</strong><br>

                          Name <input name="relatives_name1" type="text" size="18">

                          &nbsp;&nbsp;Age <input name="relatives_age1" type="text" size="3">

                          &nbsp;&nbsp;Also affected with LGMD2B? <input type="radio" name="relatives_LGMD2B1" value="Yes">Yes

						  &nbsp;&nbsp;<input type="radio" name="relatives_LGMD2B1" value="No">No<br>

						 Name <input name="relatives_name2" type="text" size="18">

                          &nbsp;&nbsp;Age <input name="relatives_age2" type="text" size="3">

                          &nbsp;&nbsp;Also affected with LGMD2B? <input type="radio" name="relatives_LGMD2B2" value="Yes">Yes

						  &nbsp;&nbsp;<input type="radio" name="relatives_LGMD2B2" value="No">No<br>

							   Name <input name="relatives_name3" type="text" size="18">

                          &nbsp;&nbsp;Age <input name="relatives_age3" type="text" size="3">

                          &nbsp;&nbsp;Also affected with LGMD2B? <input type="radio" name="relatives_LGMD2B3" value="Yes">Yes

						  &nbsp;&nbsp;<input type="radio" name="relatives_LGMD2B3" value="No">No<br>

						  Name <input name="relatives_name4" type="text" size="18">

                          &nbsp;&nbsp;Age <input name="relatives_age4" type="text" size="3">

                          &nbsp;&nbsp;Also affected with LGMD2B? <input type="radio" name="relatives_LGMD2B4" value="Yes">Yes

						  &nbsp;&nbsp;<input type="radio" name="relatives_LGMD2B4" value="No">No
