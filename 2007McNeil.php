...
<span class="home"></span><br><br>
				...
				<p><span class="style10">SPEAKER ABSTRACTS </span><br><br><br>
				  ...
				  <strong><span class="style17">Paul L. McNeil, PhD</span><br>

				  </strong><em>Medical</em><em> College of Georgia</em>&nbsp;&nbsp;<strong><br>

                  </strong> <span class="style10"><br>

                  <img src="images/conference/20-McNeil.jpg" width="135">                  <br>

                  <br>

                  <br>

                  </span><strong>Mechanisms and assays of membrane repair&nbsp;  &nbsp;</strong><br><br>

                  Cell  plasma membrane disruption is a common event under physiological conditions in  many mechanically active tissues in the mammalian body, especially in skeletal  muscle. Adaptations that act either to prevent this injury, or to repair it,  are now being characterized at the cellular and molecular level. Failure of  either adaptation, in skeletal muscle, results in disease. The extracellular Ca2+  that enters into cytosol through an open disruption initiates the repair  response. This signal rapidly triggers homotypic (and perhaps heterotypic)  fusion among cytoplasmic membranes. A reparative patch&ndash;&ndash;an abnormally enlarged  vesicular compartment&ndash;&ndash;is thereby constructed locally from internal membrane.  Exocytotic fusion of this patch with plasma membrane surrounding the disruption  completes repair. This membrane fusion-mediated repair mechanism is apparently  universal among animal cells. Proteins under investigation as possible  participants include the SNAREs, synaptotagmin 7, dysferlin, and, more  recently, annexin A1 and calpain. I will describe recent research from this  laboratory focusing on these latter two repair candidates.</p>
