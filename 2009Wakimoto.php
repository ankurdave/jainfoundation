...
<span class="home"></span><br><br>
				...
				<p><span class="style10">POSTER ABSTRACTS </span><br>
				  ...
				  <br>
				  <a href="2009Viswanathan.php" class="style18">Previous</a>&nbsp;&nbsp;<a href="2009Wein.php" class="style18">Next</a>&nbsp;&nbsp;
                  ...
                  <em>University of Washington, Seattle, WA</em><br><br>

                  <img src="images/Conf09/Wakimoto.jpg" width="135"><br><br><br>

                  <strong>Probing the Function of the Drosophila ferlin Gene</strong><br>
                  Barbara Wakimoto1,2, Kathleen Wilson1, Benjamin Ross2<br>
                  1Department of Biology and 2Molecular and Cellular Biology Program, University of<br>
                  Washington, Seattle WA<br><br>
Drosophila melanogaster offers several advantages for the study of Ferlin regulation and
function. The existence of only a single ferlin gene, called misfire (mfr), simplifies genetic
and molecular analysis. We have obtained a series of mfr point mutations and truncation
alleles that reveal a role for the Mfr protein in sperm activation during fertilization, dorsalventral
egg polarity, and the progression of early embryogenesis. Use of a mfr-GFP
transgene has allowed us to track the localization of the fusion protein during
spermatogenesis to the acrosome, a membrane bound vesicle located at the apical tip of
the sperm. This specific localization, combined with the unusual features of sperm entry
into the Drosophila egg, forms the basis for two different models of gamete membrane-membrane interactions which we
are currently testing. We are also probing the expression and function of Mfr in other tissues, including muscle, to
determine if the Drosophila Mfr might serve as an informative model for understanding the function and regulation of
Dysferlin in mammals.</p>
