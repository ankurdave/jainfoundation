...
<p>Your Total Registration Fee is <strong>$<?php echo print_html($registrant->getField('total_fee')) ?></strong>.  The registration fees cover the costs of all meeting sessions, breakfasts, breaks, and lunches.</p>
