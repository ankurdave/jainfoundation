...
<ol>
	<li>Select the above link</li>
	<li>Select "From Airport-Round Trip" or "From Airport-One Way" on the left hand side of the screen</li>
	<li>Scroll down to "Pickup locations", then to "Hotels"</li>
	<li>Select "Hyatt Regency-Bellevue" from the list</li>
...
<p>Attendees whom the Jain Foundation has agreed to reimburse should save their receipts. No more than the amount determined by the Jain foundation prior to the conference will be reimbursed. The Jain Foundation will reimburse for the following items only:</p>

<ul>
	<li>Plane ticket &ndash; coach class only; no upgrades</li>
	<li>Airport shuttle to/from SEA airport and Hyatt Regency Bellevue (~ $19/one way)</li>
	<li>Hyatt Regency Bellevue conference room rate + tax for agreed upon nights</li>
	<li>$7/day self park hotel parking &ndash; local attendees only</li>
</ul>
