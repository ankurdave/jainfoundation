...
<title>Jain Foundation Inc | Sponsored Conferences</title>
...
onMouseOut="window.document.sq4.src='images/button_ourFunded.gif'"><img src="images/button_ourFunded.gif" border="0" name="sq4" alt="Our Funded Projects" width="168" height="32"></a></td>
				...
				<tr>
                  ...
                  <td><img src="images/button_conferences_roll.gif" width="168" height="32"></td>
...
onMouseOut="window.document.sq16.src='images/button_links2.gif'"><img src="images/button_links2.gif" border="0" name="sq16" alt="Helpful Links" width="168" height="32"></a></td>
            ...
            <td valign="top" align="center"><table width="92%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td valign="top"><p class="section">Sponsored Conferences </p>
				 <strong><span class="style2">September 11-14, 2010<br>

                        Fourth Annual Dysferlin Conference</span></strong><br>

                      <em>Organized and sponsored by the Jain Foundation Inc. </em><br>
					<a href="conference2010/">2010 Conference Details</a><p class="home"><strong>
<span class="style2">June 2-5, 2009<br>

                        Third Annual Dysferlin Conference</span></strong><br>

                      <em>Organized and sponsored by the Jain Foundation Inc. </em><br>
					 <a href="2009summary.php" class="style1">2009 Conference Summary</a><br><br>

                        <strong><span class="style2">June 14-18, 2008<br>

                        Second Annual Dysferlin Conference</span></strong><br>

                      <em>Organized and sponsored by the Jain Foundation Inc. </em><br>
					 <a href="2008summary.php" class="style1">2008 Conference summary</a>

                    <p class="home"><strong>

                        <span class="style2">July 9-12, 2007<br>

                        First Annual Dysferlin Conference</span></strong><br>

                      <em>Organized and sponsored by the Jain Foundation Inc. </em><br>

                    <a href="2007summary.php" class="style1">2007 Conference summary</a></p>

                    <p><strong>

                        <span class="style2">September 5-9, 2007<br>

                        Membrane Biophysics of Fusion, Fission, and Rafts in Health and Disease <br>

                        </span></strong>61st annual meeting and symposium of the Society of General Physiologists <br>

                    <em>Sponsored in part by the Jain Foundation Inc. </em><br>

                    <a href="http://www.sgpweb.org/symposium2007.html" class="style1">Visit the conference webpage</a><br>
