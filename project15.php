...
<title>Jain Foundation Inc | Past Projects | Gene Therapy</title>
...
onMouseOut="window.document.sq16.src='images/button_links2.gif'"><img src="images/button_links2.gif" border="0" name="sq16" alt="Helpful Links" width="168" height="32"></a></td>
            ...
            <td valign="top" align="center"><table width="92%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td valign="top"><p class="section">Past Research Projects - Pre-Clinical Trials </p>

                    <p class="home"><strong><font color="#0175C2"><span class="style1">Pre-Clinical Drug Screening </span><br>
...
Dr. Nagaraju is an associate Professor of Pediatrics
   	             	  ...
   	             	  at the CNMC (Washington DC).<br>
					  <br><br>
					  <br><br>
					  <strong>PROJECT OUTCOME:  None of the 5 compounds chosen for testing produced significant improvements in muscle function in dysfelrin deficient mice.  In addition the project revealed that determining robust outcome measures to test in dysferlin deficient animals is a significant challenge. </strong>
