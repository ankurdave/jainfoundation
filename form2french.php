...
<strong><font color="#990000">2e PARTIE: HISTOIRE DE FAMILLE</font></strong> (facultatif)<br>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
					  ...
					  <tr>
                        ...
                        <td><p class="form2"><strong> Avez-vous des frères ou des s&oelig;urs avec les mêmes deux parents?</strong><br>
                          ...
                          &nbsp;&nbsp; Affecté(e) aussi avec la dystrophie? <input type="radio" name="sibling_LGMD2B1" value="Yes">Oui
						 ...
						 Nom <input name="sibling_name2" type="text" size="18">
                          ...
                          &nbsp;&nbsp; Affecté(e) aussi avec la dystrophie? <input type="radio" name="sibling_LGMD2B2" value="Yes">Oui
                          ...
                          &nbsp;&nbsp; Affecté(e) aussi avec la dystrophie? <input type="radio" name="sibling_LGMD2B3" value="Yes">Oui
                          ...
                          &nbsp;&nbsp; Affecté(e) aussi avec la dystrophie? <input type="radio" name="sibling_LGMD2B4" value="Yes">Oui
					  ...
					  <tr>
                        ...
                        <td bgcolor="#F3F9FA"><p class="form2"><strong> Avez-vous des enfants? </strong><br>
                          ...
                          &nbsp;&nbsp; Affecté(e) aussi avec la dystrophie? <input type="radio" name="children_LGMD2B1" value="Yes">Oui
						 ...
						 Nom <input name="children_name2" type="text" size="18">
                          ...
                          &nbsp;&nbsp; Affecté(e) aussi avec la dystrophie? <input type="radio" name="children_LGMD2B2" value="Yes">Oui
                          ...
                          &nbsp;&nbsp; Affecté(e) aussi avec la dystrophie?  <input type="radio" name="children_LGMD2B3" value="Yes">Oui
                          ...
                          &nbsp;&nbsp; Affecté(e) aussi avec la dystrophie? <input type="radio" name="children_LGMD2B4" value="Yes">Oui
					  ...
					  <tr>
                        ...
                        <td><p class="form2"><strong> Connaissez-vous d‚autres personnes dans votre famille ou d‚ancêtres avec la maladie?</strong><br>
                          ...
                          &nbsp;&nbsp; Affecté(e) aussi avec la dystrophie? <input type="radio" name="relatives_LGMD2B1" value="Yes">Oui
						 ...
						 Nom <input name="relatives_name2" type="text" size="18">
                          ...
                          &nbsp;&nbsp; Affecté(e) aussi avec la dystrophie? <input type="radio" name="relatives_LGMD2B2" value="Yes">Oui
                          ...
                          &nbsp;&nbsp; Affecté(e) aussi avec la dystrophie? <input type="radio" name="relatives_LGMD2B3" value="Yes">Oui
                          ...
                          &nbsp;&nbsp; Affecté(e) aussi avec la dystrophie? <input type="radio" name="relatives_LGMD2B4" value="Yes">Oui
