...
$sql=	"UPDATE registrants SET " .
  ...
  //echo $sql;
	...
	?><script language="javascript">window.location="form3polish.php";</script><?
...
onMouseOut="window.document.sq8.src='images/button_faq.gif'"><img src="images/button_faq.gif" border="0" name="sq8" alt="FAQ on LGMD2B/Miyoshi" width="168" height="32"></a></td>
            ...
            <td valign="top" align="center">
				  ...
				  <form name="registrant_2" method="post" action="form2polish.php" onSubmit="validate();">
...
<strong><font color="#990000">CZESC 2: POCHODZENIE RODZINNE</font></strong> (informacja dodatkowa)<br>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        ...
                        <td bgcolor="#F3F9FA"><p class="form2"><strong>Czy rodzice maja dystrofie miesniowa LGMD?</strong><strong><br>

                          Matka</strong>

                            <input type="radio" name="mom_disease" value="Yes">Tak 

						  &nbsp;&nbsp;<input type="radio" name="mom_disease" value="No">Nie 

                          &nbsp;&nbsp;<br>

                          <strong>Ojciec</strong>

                          <input type="radio" name="dad_disease" value="Yes">Tak 

						  &nbsp;&nbsp;<input type="radio" name="dad_disease" value="No">Nie 
					  ...
					  <tr>
                        ...
                        <td><p class="form2"><strong>Czy masz rodzienstwo (rodzone)?</strong><br>

                          Imie <input name="sibling_name1" type="text" size="18">

                          &nbsp;&nbsp;Wiek <input name="sibling_age1" type="text" size="3">

                          &nbsp;&nbsp;Czy tez ma LGMD2B? <input type="radio" name="sibling_LGMD2B1" value="Yes">Tak

						  &nbsp;&nbsp;<input type="radio" name="sibling_LGMD2B1" value="No">Nie<br>

						 Imie <input name="sibling_name2" type="text" size="18">

                          &nbsp;&nbsp;Wiek <input name="sibling_age2" type="text" size="3">

                          &nbsp;&nbsp;Czy tez ma LGMD2B? <input type="radio" name="sibling_LGMD2B2" value="Yes">Tak

						  &nbsp;&nbsp;<input type="radio" name="sibling_LGMD2B2" value="No">Nie<br>

							   Imie <input name="sibling_name3" type="text" size="18">

                          &nbsp;&nbsp;Wiek <input name="sibling_age3" type="text" size="3">

                          &nbsp;&nbsp;Czy tez ma LGMD2B? <input type="radio" name="sibling_LGMD2B3" value="Yes">Tak

						  &nbsp;&nbsp;<input type="radio" name="sibling_LGMD2B3" value="No">Nie<br>

						  Imie <input name="sibling_name4" type="text" size="18">

                          &nbsp;&nbsp;Wiek <input name="sibling_age4" type="text" size="3">

                          &nbsp;&nbsp;Czy tez ma LGMD2B? <input type="radio" name="sibling_LGMD2B4" value="Yes">Tak

						  &nbsp;&nbsp;<input type="radio" name="sibling_LGMD2B4" value="No">Nie
					  ...
					  <tr>
                        ...
                        <td bgcolor="#F3F9FA"><p class="form2"><strong>Czy masz dzieci?</strong><br>

                          Imie <input name="children_name1" type="text" size="18">

                          &nbsp;&nbsp;Wiek <input name="children_age1" type="text" size="3">

                          &nbsp;&nbsp; Czy tez ma LGMD2B? <input type="radio" name="children_LGMD2B1" value="Yes">Tak

						  &nbsp;&nbsp;<input type="radio" name="children_LGMD2B1" value="No">Nie<br>

						 Imie <input name="children_name2" type="text" size="18">

                          &nbsp;&nbsp;Wiek <input name="children_age2" type="text" size="3">

                          &nbsp;&nbsp; Czy tez ma LGMD2B? <input type="radio" name="children_LGMD2B2" value="Yes">Tak

						  &nbsp;&nbsp;<input type="radio" name="children_LGMD2B2" value="No">Nie<br>

							   Imie <input name="children_name3" type="text" size="18">

                          &nbsp;&nbsp;Wiek <input name="children_age3" type="text" size="3">

                          &nbsp;&nbsp; Czy tez ma LGMD2B? <input type="radio" name="children_LGMD2B3" value="Yes">Tak

						  &nbsp;&nbsp;<input type="radio" name="children_LGMD2B3" value="No">Nie<br>

						  Imie <input name="children_name4" type="text" size="18">

                          &nbsp;&nbsp;Wiek <input name="children_age4" type="text" size="3">

                          &nbsp;&nbsp; Czy tez ma LGMD2B? <input type="radio" name="children_LGMD2B4" value="Yes">Tak

						  &nbsp;&nbsp;<input type="radio" name="children_LGMD2B4" value="No">Nie
					  ...
					  <tr>
                        ...
                        <td><p class="form2"><strong>Wymien krewnych i przodkow ktorzy maja/mieli dystrofie miesniowa.</strong><br>

                          Imie <input name="relatives_name1" type="text" size="18">

                          &nbsp;&nbsp;Wiek <input name="relatives_age1" type="text" size="3">

                          &nbsp;&nbsp; Czy tez ma LGMD2B? <input type="radio" name="relatives_LGMD2B1" value="Yes">Tak

						  &nbsp;&nbsp;<input type="radio" name="relatives_LGMD2B1" value="No">Nie<br>

						 Imie <input name="relatives_name2" type="text" size="18">

                          &nbsp;&nbsp;Wiek <input name="relatives_age2" type="text" size="3">

                          &nbsp;&nbsp; Czy tez ma LGMD2B? <input type="radio" name="relatives_LGMD2B2" value="Yes">Tak

						  &nbsp;&nbsp;<input type="radio" name="relatives_LGMD2B2" value="No">Nie<br>

							   Imie <input name="relatives_name3" type="text" size="18">

                          &nbsp;&nbsp;Wiek <input name="relatives_age3" type="text" size="3">

                          &nbsp;&nbsp; Czy tez ma LGMD2B? <input type="radio" name="relatives_LGMD2B3" value="Yes">Tak

						  &nbsp;&nbsp;<input type="radio" name="relatives_LGMD2B3" value="No">Nie<br>

						  Imie <input name="relatives_name4" type="text" size="18">

                          &nbsp;&nbsp;Wiek <input name="relatives_age4" type="text" size="3">

                          &nbsp;&nbsp; Czy tez ma LGMD2B? <input type="radio" name="relatives_LGMD2B4" value="Yes">Tak

						  &nbsp;&nbsp;<input type="radio" name="relatives_LGMD2B4" value="No">Nie
                      ...
                      <tr>
                        ...
                        <td align="center" height="40"><input name="Continue" type="submit" id="Continue" value="Kontynuowac">&nbsp;&nbsp;&nbsp;
