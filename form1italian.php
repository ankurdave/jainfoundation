...
?><script language="javascript">window.location="form2italian.php";</script><?
...
onMouseOut="window.document.sq16.src='images/button_links2.gif'"><img src="images/button_links2.gif" border="0" name="sq16" alt="Helpful Links" width="168" height="32"></a></td>
            ...
            <td valign="top" align="center">
			  ...
			  <form name="registrant_1" method="post" action="form1italian.php" onSubmit="return validate();">
			...
			<table width="94%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td valign="top"><p class="section">Registrazione Patienzi</p>

                    <p class="home"> <strong><font color="#0175C2">Form di registrazione</font></strong><br>

                          Questa form di registrazione è divisa in 3 parti a richede approssimativamente 15 minuti per essere completata. Le tue risposte saranno molto utili per le nostre analisi sulla variabilità della progressione di questa malattia e per molte altre caratteristiche specifiche di questa forma di distrofia dei cingoli (LGMD). Anche se qualche domanda è facoltativa, per favore prova a rispondere a tutte le domande contenute nella form. Questo sito è sicuro e protetto con una criptazione SSL. <strong>TUTTE LE INFORMAZIONI SARANNO TENUTE RISERVATE.</strong><br>

                      <br>

Se non desideri registrarti sul nostro sito, vorremmo lo stesso avere un contatto con te. In tal caso puoi contattare la Dott.ssa Plavi Mittal all'indirizzo <a href="mailto:plavimittal@jain-foundation.org">plavimittal@jain-foundation.org</a> <br><br>
...
<strong><font color="#990000">PARTE 1: INFORMAZIONI DI BASE </font></strong><br><br>
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
                      ...
                      <tr bgcolor="#F3F9FA">
                        ...
                        <td width="30%"><p class="form">Nome</p></td>
                      ...
                      <tr>
                       ...
                       <td><p class="form">Telefono (facoltativo)</p></td>
                      ...
                      <tr bgcolor="#F3F9FA">
                        ...
                        <td><p class="form">Indirizzo (facoltativo)</p></td>
                      ...
                      <tr>
                        ...
                        <td><p class="form">Comune/Provincia/CAP</p></td>
					  ...
					  <tr bgcolor="#F3F9FA">
                        ...
                        <td width="30%"><p class="form">Nazione</p></td>
                      ...
                      <tr bgcolor="#F3F9FA">
                       ...
                       <td bgcolor="#F3F9FA"><p class="form">Età attuale</p></td>
                      ...
                      <tr>
                       ...
                       <td><p class="form">Età al momento della diagnosi</p></td>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        ...
                        <td bgcolor="#F3F9FA"><p class="form2"><strong>La tua diagnosi è stata fatta e/o confermata attraverso:<br>

                          a.</strong>	Esame fisico? 

                          <input type="radio" name="diagnosis_examination" value="Yes">Si 

						  &nbsp;&nbsp;<input type="radio" name="diagnosis_examination" value="No">No 

                          &nbsp;&nbsp;<input type="radio" name="diagnosis_examination" value="Not Sure">Non so                          <br>

                          <strong>b</strong>.	Livello di CK (creatin-chinasi)? 

                          <input type="radio" name="diagnosis_CK_level" value="Yes">Si
                          ...
                          Solo se lo sai, qual‚era il tuo livello di CK alla diagnosi? 

                          <input name="diagnosis_CK_level_number" type="text" size="8" maxlength="8">

                          <br>

                          <strong>c.</strong>	Biopsia muscolare? <input type="radio" name="diagonsis_muscle_biopsy" value="Yes">Si 
                          ...
                          <strong>d.</strong>	Esame del sangue (conta dei monociti)? 

                          <input type="radio" name="diagnosis_blood_cell_test" value="Yes">Si 
                          ...
                          <strong>e.</strong>	Analisi della mutazione (sequenziamento del DNA)? 

                          <input type="radio" name="diagnosis_mutational" value="Yes">Si 
                      ...
                      <tr>
                        ...
                        <td><p class="form2"><strong>Data Della Registrazione 
