...
<span class="home"></span><br><br>
				...
				<p><span class="style10">POSTER ABSTRACTS </span><br>
                  ...
                  <strong><span class="style17">Graziella Messina, PhD</span></strong><br>

                  <em>Laboratory of Dr. Giulio Cossu, Stem Cell Research Institute, Milan, Italy</em><br>

                    <br>

                    <img src="images/conference/39-Messina.jpg" width="135">                    <br>

                  <br>

                  <br>

                  <strong>A universal donor mesoangioblast for the cell  therapy of muscular dystrophies</strong><strong> </strong><br>

Graziella Messina1, Sara Benedetti1,  Rossana Tonlorenzi1, Anna Innocenzi1, Stefania Monteverde1,  Diego Covarello1, Maria Rescigno2 and Giulio Cossu1</p>

                <p>1SCRI DiBit, H.San Raffaele, Milan, Italy, 2European Institute of Oncology,  Milan, Italy</p>

                <p>A  cell therapy for the treatment of the Muscular Dystrophies is based upon  transplantation of either autologous or HLA&minus;matched donor stem cells. Even if  successful, the costs involved in these &ldquo;patient-tailored therapies&rdquo; are likely  to be excessive and will limit widespread application. We have recently  described a class of stem cell, the mesoangioblast, that has been shown to be  effective in achieving muscle regeneration and functional improvement upon  intra-arterial delivery in mouse or canine models of muscular dystrophy. The  aim of this study is to create an immortal, universal, donor human  mesoangioblast that will be accepted by the immune system of different

patients, in the absence of (or with minimal)  immune suppression for the cell therapy of muscular dystrophy. We exploited  floxed hTert immortalization of human mesoangioblasts to generate reversibly  immortal clones. We plan to modify the immune appearance of stem cells by  blocking expression of HLA antigens, responsible for immune rejection, and  rather expressing the HLA-G, from human placenta, that allows the fetus to  escape immune rejection from the mother. At each step we will test insertion  site, tumorigenicity, myogenic potential and proper escape from immune  surveillance in NOD/SCID dystrophic mice reconstituted with human mismatched  lymphocytes. The final clonal progeny should be ready to be transplanted in  dystrophic patients (after excision of the telomerase cassette) with minimal or  no immune suppression. This project will lead to a safe and economically  affordable cell therapy for all patients affected by recessive or X-linked  primary myopathies.&nbsp;</p>
