...
<span class="home"></span><br><br>
				...
				<p><span class="style10">SPEAKER ABSTRACTS </span><br><br><br>
				  ...
				  <strong><span class="style17">R. Jude Samulski, PhD </span><br>

				  </strong><em>University</em><em> of North Carolina</em><strong><br>

                  </strong> <span class="style10"><br>

                  <img src="images/conference/5-Samulski.jpg" width="135">                  <br>

                  <br>

                  <br>

                  <strong>Adeno-associated virus vectors for targeted and repeat  delivery</strong></span><br>

                  <br>

                  Adeno-associated virus vectors for targeted  and repeat delivery will capitalize on AAV vector results derived from the  on-going AAV Phase I DMD clinical trial. The advent of novel AAV vectors  (serotype 1-11) and the solving of the capsid crystal structure has allowed us  and others to carry out rational design of AAV capsids to generate laboratory  strains of gene delivery vehicles. Using such an approach, we have been  successful in engineering AAV type 2 liver tropic vectors into a muscle  enhanced transducing virus using only 5 amino acids derived from AAV type 1  capsid backbone.&nbsp; This novel chimeric reagent (AAV 2.5) has a distinct  immune profile when compared to capsid backbone of parent serotypes and has  high efficiency for muscle transduction. Due to the advantages of this chimeric  AAV particle we recently initiated a Phase I Gene Therapy clinical trial for  DMD with Dr. Xiao. Early information derived from these efforts has provided  hypothesis driven approaches to better understand basic steps such as immune  response to viral

capsid,  viral /receptor interaction, intra-cellular trafficking, and transgene  expression. In the proposed studies, we hope to capitalize on these  observations by deriving a collection of disease tropic vectors with novel  immune profile that will allow for repeat administration.</p>
