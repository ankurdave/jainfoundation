...
<title>Jain Foundation Inc | Our Funded Projects | Chaperones</title>
...
onMouseOut="window.document.sq16.src='images/button_links2.gif'"><img src="images/button_links2.gif" border="0" name="sq16" alt="Helpful Links" width="168" height="32"></a></td>
            ...
            <td valign="top" align="center"><table width="92%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td valign="top"><p class="section">Research Projects - Chaperones </p>

                    <p class="home"><strong><font color="#0175C2"><span class="style1">Peptide Mediated Retargeting of Mutant Dysferlins</span> <br>

                    </font></strong>Simone Spuler, Charit&eacute;, University Medicine Berlin (Germany) <br>

                        <br>

                         <strong>Project Objective</strong><br>

                         Prevent the misfolding and aggregation of mutant dysferlins<br>

                          <br>

                          Certain missense mutations of dysferlin lead to faulty protein folding and to accumulation of dysferlin in the endoplasmic reticulum (ER). Misfolded proteins are rapidly degraded in the ER via the ubiquitine proteasome system. We aim to find a way to target dysferlin, trapped in the ER, to the sarcolemma using peptides and other small molecules. <br>

                         <br>

                         <img src="images/Spuler.jpg" width="160" height="140" align="left">                       <br>

                       	    <strong><a href="http://www.charite-buch.de/kfo192/" target="_blank">Simone Spuler, MD</a></strong><br>

                       	    <br>

                          	 Dr. Simone Spuler is a neurologist and full professor for myology at the Experimental and Clinical Research Center of the Charit&eacute;, University Medicine Berlin and the Max-DelbrŸck Center of Molecular Medicine, Berlin, Germany.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     </p>
