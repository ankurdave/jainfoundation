...
$sql=	"UPDATE registrants SET " .
  ...
  //echo $sql;
	...
	?><script language="javascript">window.location="form3spanish.php";</script><?
...
onMouseOut="window.document.sq8.src='images/button_faq.gif'"><img src="images/button_faq.gif" border="0" name="sq8" alt="FAQ on LGMD2B/Miyoshi" width="168" height="32"></a></td>
            ...
            <td valign="top" align="center">
				  ...
				  <form name="registrant_2" method="post" action="form2spanish.php" onSubmit="validate();">
...
<strong><font color="#990000">PARTE 2: HISTORIA FAMILIAR</font></strong> (opcional)<br>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        ...
                        <td bgcolor="#F3F9FA"><p class="form2"><strong>&iquest;Sus padres tienen la enfermedad?</strong><strong><br>
					  ...
					  <tr>
                        ...
                        <td><p class="form2"><strong>&iquest;Tiene Ud. hermanos de sus mismos padres (padre y madre)?</strong><br>
                          ...
                          &nbsp;&nbsp;&iquest;Tambi&eacute;n afectado/a con la LGMD2B? <input type="radio" name="sibling_LGMD2B1" value="Yes">
                          ...
                          &nbsp;&nbsp;&iquest;Tambi&eacute;n afectado/a con la LGMD2B? 
					  ...
					  <tr>
                        ...
                        <td bgcolor="#F3F9FA"><p class="form2"><strong>&iquest;Tiene Ud. hijos?</strong><br>
					  ...
					  <tr>
                        ...
                        <td><p class="form2"><strong>&iquest;Conoce de alguna otra persona de su familia con la enfermedad?</strong><br>
