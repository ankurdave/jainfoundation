...
<span class="home"></span><br><br>
				...
				<p><span class="style10">SPEAKER ABSTRACTS </span><br><br><br>
				  ...
				  <strong><span class="style17">Giulio Cossu, MD</span><br>

				  </strong><em>Stem Cell Research Institute. H. S. Raffaele Via  Olgettina 58, 20132, Milan</em>&nbsp;&nbsp;<strong><br>

                  </strong> <span class="style10"><br>

                  <img src="images/conference/1-Cossu.jpg" width="135">                  <br>

                  <br>

                  <br>

                  </span><strong>Towards cell therapy for muscular dystrophies&nbsp;  &nbsp;</strong><br><br>

                  Mesoangioblasts are recently characterized  stem cells that are associated with the vasculature and can differentiate into  different types of solid mesoderm including skeletal muscle (Minasi et al. <em>Development</em> 129:2773, 2002). When either  wild type or dystrophic, genetically corrected, mesoangioblasts were delivered  intra-arterially to dystrophic muscle of a-sarcoglycan null mice  (a model for limb girdle muscular dystrophy), they resulted in a dramatic  functional amelioration of the dystrophic phenotype (Sampaolesi et al. <em>Science</em> 301, 487, 2003). Intra-arterial  or systemic delivery of wild type, non DLA matched mesoangioblasts resulted in  a partial recovery of muscle morphology and function, dystrophin expression and  clinical amelioration, which persisted for a few months after removal of immune  suppression. Delivery of autologous mesoangioblasts expressing human  micro-dystrophin did not cause a comparable amelioration, despite widespread  micro-dystrophin expression (Sampaolesi et al. <em>Nature</em> 444:574, 2006).

These  results show efficacy of cell therapy in a large, immuno-competent animal and  set the rationale for a future clinical trial, using donor cells from an  HLA-matched donor under immune suppression. Moreover, human adult mesoangioblasts  were isolated and&nbsp;expanded in vitro from muscle biopsies: they were shown  to correspond to a subset of human pericytes and, more importantly, to  differentiate spontaneously in skeletal muscle with high efficiency (Dellavalle  et al. <em>Nature Cell Biol</em> 9:255, 2007).  Based on these results a first clinical trial with donor mesoangioblasts is  planned for the near future. Problems still facing this approach and possible  strategies to overcome them will be discussed.&nbsp;</p>
