...
<span class="home"></span><br><br>
				...
				<p><span class="style10">POSTER ABSTRACTS </span><br>
                  ...
                  <em>Laboratories of Dr. Eric Kmiec, University  of Delaware, and Dr. Thomas Rando, Stanford University School  of Medicine</em><br>

                  <br>

                  <img src="images/conference/38-Maguire.jpg" width="135">                  <br><br><br>

                  <strong>Oligonucleotide  mediated gene repair of mutant dystrophin and applications for LGMD2B</strong>

                <br>Katie  Maguire, PhD, Eric B. Kmiec, PhD and Thomas Rando, MD, PhD

                <br><br>

                Targeted gene repair is a method of gene  therapy in which synthetic modified single-stranded oligonucleotides are used  to correct single base mutations in mutant genes.&nbsp; Gene repair approaches  as a treatment for Duchenne Muscular Dystrophy have yielded promising results  in mice and dog models. Currently, semi-quantitative analyses of this technique  reveal that an <em>ex vivo</em> approach to genetically curing DMD is more  efficient than when performed <em>in vivo</em>.&nbsp; Here we describe two  quantitative analyses, QPCR using a Taqman probe and quantitative RT PCR, both  of which measure the frequency of gene repair of a mutant dystrophin gene in  primary myoblasts from mdx5cv mice.&nbsp; We report that over 1% of  a targeted population contain the corrected gene after treatment with the  specific oligonucleotides. Recently, we have shown that by knocking down the  level of

Msh2  using RNAi the frequency of gene repair can be enhanced.&nbsp; This mismatch  repair protein, Msh2, has been shown to inhibit the gene repair reaction, which  may occur through its involvement with DNA damage response proteins. We use  RNAi, designed to downregulate Msh2, to circumvent this inhibitory pathway in  conjunction with the transfected correcting oligonucleotides. This combinatorial  strategy results in a 3-fold enhancement in gene repair.&nbsp; The overall goal  of these experiments is to develop a robust and quantitative method of gene  repair for DMD in primary cells. We also outline a similar approach to repair a  genetic mutation in the dysferlin gene in an <em>ex vivo</em> therapeutic  approach to LGMD.</p>
