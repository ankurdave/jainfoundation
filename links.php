...
<title>Jain Foundation Inc | Helpful Links</title>
...
onMouseOut="window.document.sq8.src='images/button_faq.gif'"><img src="images/button_faq.gif" border="0" name="sq8" alt="FAQ on LGMD2B/Miyoshi" width="168" height="32"></a></td>
                ...
                <tr>
                  ...
                  <td><img src="images/button_links2_roll.gif" width="168" height="32"></td>
            ...
            <td valign="top" align="center"><table width="92%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td valign="top"><p class="section">Helpful Links</p>

                    <p class="home">We have identified resources for information either about LGMD2B/Miyoshi in particular or muscular dystrophies in general.  Also listed are several organizations pertinent to patients suffering from this disease.<br>
...
<br>
                      ...
                      <font color="#0175C2"><br>

                      <strong>Muscular Dystrophy Association</strong></font><br>

The largest voluntary national association dedicated to neuromuscular diseases.<br>

<a href="http://www.mdausa.org/" target="_blank">http://www.mdausa.org/</a><br>

<font color="#0175C2"><strong><br>

National Organization for Rare Disorders</strong></font><br>

Federation of voluntary health organizations helping people with rare diseases.<br>

<a href="http://www.rarediseases.org/" target="_blank">http://www.rarediseases.org/</a><br>

<br>

<font color="#0175C2"><strong>EURORDIS</strong></font><br>

The European Organization for Rare Diseases.<br>

<a href="http://www.eurordis.org/" target="_blank">http://www.eurordis.org/</a><br>
...
<strong><font color="#0175C2">PubMed</font></strong><br>

Access to scientific journals, and links to sites providing full text articles.<br>

<a href="http://www.ncbi.nlm.nih.gov/entrez/query.fcgi" target="_blank">http://www.ncbi.nlm.nih.gov/entrez/query.fcgi</a><br>

                          <font color="#0175C2"><br>

                          <strong>NCBI (National Center for Biotechnological Information)</strong></font><br>

  Clinical information and history of diagnosis of LGMD2B.<br>

  <a href="http://www.ncbi.nlm.nih.gov/entrez/dispomim.cgi?id=253601" target="_blank">http://www.ncbi.nlm.nih.gov/entrez/dispomim.cgi?id=253601</a>  <br>

  <br>

  <font color="#0175C2"><strong>Leiden Muscular Dystrophy pages</strong></font><br>

  Scientific information on research and diagnosis of LGMD2B.<br>

  <a href="http://www.dmd.nl/dysf_home.html" target="_blank">http://www.dmd.nl/dysf_home.html</a><br>

  Non-scientific information for all LGMD2B.<br>

  <a href="http://www.dmd.nl/" target="_blank">http://www.dmd.nl/</a> </p>
