            ...
            <td valign="top" align="center"><table width="92%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td valign="top"><p class="section">Relevant Scientific Papers</p>
                    ...
                    <p class="home"> <strong><font color="#0175C2">Recombinant

                          Dysferlin</font></strong><br>

                      <br>

                      	   <a href="http://www.ncbi.nlm.nih.gov/entrez/query.fcgi?db=pubmed&cmd=Retrieve&dopt=AbstractPlus&list_uids=12006649&query_hl=116&itool=pubmed_docsum" target="_blank"><strong>Utrophin binds laterally along actin filaments and

                       	   can couple costameric actin with sarcolemma when overexpressed

                       	   in dystrophin-deficient muscle</strong></a><br>

                       	   Rybakova IN, Patel JR, Davies KE, Yurchenco PD, Ervasti

                       	   JM.<br>

                       	   Mol Biol Cell. 2002 May;13(5):1512-21.<br>

                           <br>

                           <strong><a href="http://www.ncbi.nlm.nih.gov/entrez/query.fcgi?db=pubmed&cmd=Retrieve&dopt=AbstractPlus&list_uids=15121988&query_hl=13&itool=pubmed_docsum" target="_blank">Long-term intravenous treatment of Pompe disease

                           with recombinant human alpha-glucosidase from milk</a></strong><br>

                           Van den Hout JM, Kamphoven JH, Winkel LP, Arts WF,

                           De Klerk JB, Loonen MC, Vulto AG, Cromme-Dijkhuis

                           A, Weisglas-Kuperus N, Hop W, Van Hirtum H, Van Diggelen

                           OP, Boer M, Kroos MA, Van Doorn PA, Van der Voort

                           E, Sibbles B, Van Corven EJ, Brakenhoff JP, Van Hove

                           J, Smeitink JA, de Jong G, Reuser AJ, Van der Ploeg

                           AT.<br>

                           Pediatrics. 2004 May;113(5):e448-57.<br>

                           <br>

                           <strong><a href="http://www.ncbi.nlm.nih.gov/entrez/query.fcgi?db=pubmed&cmd=Retrieve&dopt=AbstractPlus&list_uids=15776317&query_hl=15&itool=pubmed_docsum" target="_blank">Enzyme replacement therapy in classical infantile

                           pompe disease: results of a ten-month follow-up study</a></strong><br>

                           Klinge L, Straub V, Neudorf U, Voit T.<br>

                           Neuropediatrics. 2005 Feb;36(1):6-11.<br>

                           <br>

                           <strong><a href="http://www.ncbi.nlm.nih.gov/entrez/query.fcgi?db=pubmed&cmd=Retrieve&dopt=AbstractPlus&list_uids=16898258&query_hl=122&itool=pubmed_docsum" target="_blank">Pompe disease (glycogen storage disease type

                           II): clinical features and enzyme replacement therapy</a></strong><br>

                           van der Beek NA, Hagemans ML, van der Ploeg AT, Reuser

                           AJ, van Doorn PA.<br>

                        Acta Neurol Belg. 2006 Jun;106(2):82-6.</p>
