...
<img src="http://<?php echo $_SERVER['HTTP_HOST'], preg_replace('~/[^/]+$~', '', $_SERVER['PHP_SELF']), "/abstract-image.php?id=" . $data['id'] ?>" class="picture" width="100" align="left" hspace="13" vspace="13" />
