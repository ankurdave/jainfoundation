...
<span class="home"></span><br><br>
				...
				<p><span class="style10">SPEAKER ABSTRACTS </span><br><br><br>
				  ...
				  <strong><span class="style17">Steven S. Vogel, PhD</span><br>

				  </strong><em>NIAAA, National Institutes of Health</em>&nbsp;&nbsp;<strong><br>

                  </strong> <span class="style10"><br>

                  <img src="images/conference/21-Vogel.jpg" width="135">                  <br>

                  <br>

                  <br>

                  </span><strong>TSea  Urchins: A model system for studying exocytosis, endocytosis, membrane repair  and DYSFERLIN?&nbsp;  &nbsp;</strong><br><br>

                  Limb-Girdle muscular dystrophy-2B and Myoshi Myopathy, another  form of muscular dystrophy, are both caused by mutations in the dysferlin gene.  Little is known about the cellular function of the dysferlin gene product,  though it does seem to be involved in membrane repair mechanisms. Developing  sea urchin eggs have been used as a model system for studying calcium triggered  membrane fusion, endocytosis, and membrane wound repair. Recent efforts on  sequencing the sea urchin genome have revealed that sea urchin has a gene  encoding a human dysferlin homolog. Thus, morpholinos can potentially be  designed to knock out sea urchin dysferlin expression. We will describe several  laser-scanning two-photon microscope based assays for monitoring wound repair,  exocytosis, endocytosis, and cell division in developing sea urchin eggs, and  explain how they might be used, in conjunction with morpholinos, to investigate  the cellular function of sea urchin dysferlin.&nbsp; &nbsp;</p>
