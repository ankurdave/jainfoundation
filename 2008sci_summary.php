...
<span class="home"></span><br><br>
              ...
              <tr>
                ...
                <td><div align="left" class="home style4">
                  ...
                  <p><a href="2008summary.php"><img src="images/button_gen_sum.gif" width="79" height="40" border="0"></a> &nbsp;&nbsp;<a href="2008sci_summary.php"><img src="images/button_sci_sum.gif" width="79" height="40" border="0"></a> &nbsp;&nbsp;<a href="2008abstracts.php"><img src="images/button_speak_abs.gif" width="79" height="40" border="0"></a> &nbsp;&nbsp;<a href="2008posters.php"><img src="images/button_post_abs.gif" width="79" height="40" border="0"></a> &nbsp;&nbsp;<a href="2008BOsession.php"><img src="images/button_breakoutsessions.gif" border="0"></a> &nbsp;&nbsp;<a href="shows/dysferlinconference2008.html" target="_blank"><img src="images/button_show.gif" width="79" height="40" border="0"></a><br>

                      <span class="home"></span><br>

                    <br>

                      <span class="style13">SCIENTIFIC SUMMARY </span><br><br><br>
Click here to download a <a href="downloads/summary2008.pdf" class="style14" target="_blank">pdf version</a> of the full conference summary.<br><br>

                      <br>

  <a href="2008sci_summary_s1.php" class="style14">Session I: Dysferlinopathy - Mechanisms of Pathology</a><br>

  <a href="2008sci_summary_s2.php" class="style14">Session II: Dysferlinopathy and the Immune System</a><br>

  <a href="2008sci_summary_s3.php" class="style14">Session III: Membrane Fusion and Repair</a> <br>

  <a href="2008sci_summary_s4.php" class="style14">Session IV: Clinical Aspects of Dysferlinopathy</a><br>

  <a href="2008sci_summary_s5.php" class="style14">Session V: New Research Tools and Technologies</a><br>

  <a href="2008sci_summary_s6.php" class="style14">Session VI: Gene Therapy</a><br>

  <a href="2008sci_summary_s7.php" class="style14">Session VII: Compensating for Dysferlin Deficiency</a><br>
  
  <a href="2008sci_summary_s8.php" class="style14">Session VIII: Ferlin Family Structure and Function</a><br>
  
  <a href="2008sci_summary_s9.php" class="style14">Session IX: The Ferlin Family - Beyond Muscle</a><br>
  
  <a href="2008sci_summary_s10.php" class="style14">Session X: Muscle Stem Cells</a>
   </p>
