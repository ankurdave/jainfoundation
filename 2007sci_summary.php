...
<span class="home"></span><br><br>
              ...
              <tr>
                ...
                <td><div align="left" class="home style4">
                  ...
                  <p><a href="2007summary.php"><img src="images/button_gen_sum.gif" width="79" height="40" border="0"></a> &nbsp;&nbsp;<a href="2007sci_summary.php"><img src="images/button_sci_sum.gif" width="79" height="40" border="0"></a> &nbsp;&nbsp;<a href="2007abstracts.php"><img src="images/button_speak_abs.gif" width="79" height="40" border="0"></a> &nbsp;&nbsp;<a href="2007posters.php"><img src="images/button_post_abs.gif" width="79" height="40" border="0"></a> &nbsp;&nbsp;<a href="2007program.php"><img src="images/button_conf_prog.gif" border="0"></a> &nbsp;&nbsp;<a href="shows/dysferlinconference2007.html" target="_blank"><img src="images/button_show.gif" width="79" height="40" border="0"></a><br>

                      <span class="home"></span><br>

                    <br>

                      <span class="style13">SCIENTIFIC SUMMARY </span><br>

                      <br>

                    <br>

                    Click here to download a <a href="downloads/CONFERENCE_SUMMARY.pdf" class="style14">pdf version</a> of the full conference summary.<br>

  <a href="2007sci_summary_s1.php" class="style14"><br>

  <br>

    Session I: Stem Cell Therapy</a><br>

  <a href="2007sci_summary_s2.php" class="style14">Session II: Dysferlin Gene Therapy</a><br>

  <a href="2007sci_summary_s3.php" class="style14">Session III: Mutation Analysis and Diagnosis</a> <br>

  <a href="2007sci_summary_s4.php" class="style14">Session IV: Dysferlin Function</a><br>

  <a href="2007sci_summary_s5.php" class="style14">Session V: Membrane Fusion and Repair</a><br>

  <a href="2007sci_summary_s6.php" class="style14">Session VI: Other Therapeutic Strategies</a><br>

  <a href="2007sci_summary_s7.php" class="style14">Session VII: Immune Involvement and Cell Death</a> </p>
