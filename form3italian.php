                ...
                <td valign="top"><p class="section">Registrazione Pazienti</p>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        ...
                        <td bgcolor="#F3F9FA"><p class="form2"><strong>Età nella quale hai notato i primi sintomi: <input name="age_symptoms" type="text" size="3">
                      ...
                      <tr>
                       ...
                       <tr>
                        ...
                        <td bgcolor="#F3F9FA"><p class="form2"><strong>Hai problemi con le seguenti attività:<br>
						  ...
						  &nbsp;&nbsp;&nbsp;&nbsp;A che et<span class="home">&agrave;</span> è cominciato il problema? 
