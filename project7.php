...
<title>Jain Foundation Inc | Our Funded Projects | India</title>
...
onMouseOut="window.document.sq16.src='images/button_links2.gif'"><img src="images/button_links2.gif" border="0" name="sq16" alt="Helpful Links" width="168" height="32"></a></td>
            ...
            <td valign="top" align="center"><table width="92%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td valign="top"><p class="section">Diagnostic Projects - India </p>



                    <p class="home"><strong><font color="#0175C2"><span class="style1">Diagnosis in India </span><br>

                    </font></strong>All India Institute of Medial Sciences  (New Delhi, India)<br>
                        ...
                        <br>
                         ...
                         Identify new patients and increase awareness of LGMD2B
                         ...
                         in India <br>
                          ...
                          Funding is directed to AIIMS (<a href="http://www.aiims.edu" target="_blank">http://www.aiims.edu/</a>),



                           New Delhi, India for developing a blood test for the diagnosis



                           of Miyoshi. Most of the funding will provide a free



                           blood test to approximately 300 patients in India.<br>



                           Athena Diagnostics provides a blood test to diagnose



                           Dysferlin deficiency in the US and Western Europe.



                           This is an easy first diagnosis and is a reliable



                           method. Only 15 mls of blood is needed from the patient.



                           The test looks for the absence (or reduced expression)



                           of Dysferlin in the patient blood as compared to normal



                           blood. This test is expensive and not available to



                           patients in India. The foundation and AIIMS are developing the test in India and  will make it available to the patients in



                           India for no charge.<br>
...
1.	Assist diagnosis and awareness of Miyoshi/LGMD2B in India<br>
...
2. Collect statistical data from many patients to better understand the disease
...
3.	Identify a patient pool for clinical trials in the future<br>
