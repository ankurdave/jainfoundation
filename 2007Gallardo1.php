...
<span class="home"></span><br><br>
				...
				<p><span class="style10">POSTER ABSTRACTS </span><br>
                  ...
                  <strong><span class="style17">Eduard Gallardo, PhD</span></strong><br>

                  <em>Laboratory of Dr. Isabel Illa, Department of  Neurology, Hospital de la Santa Creu i Sant Pau, Barcelona, Spain</em><br>

                  <br>

                  <img src="images/conference/10-Gallardo.jpg" width="135">                  <br><br><br>

                  <strong>Diagnostic strategies for dysferlinopathies:  Mutational analysis and protein expression using peripheral blood monocytes</strong><strong> <br>

                  </strong>

                E. Gallardo, N. De Luna, R.  Dominguez-Perles, P. Gallano, R. Rojas-Garc&iacute;a, I. Illa

                <br>

                    <br>

                    The fact that dysferlin protein is expressed  in peripheral blood monocytes prompted us to develop diagnostic strategies  using this cell population, which constitutes a less invasive source of RNA and  protein. We designed a mutational screening strategy using cDNA from monocytes  that covered all 55 exons and the 5&rsquo; and 3&rsquo; UTR in 14 PCR fragments. We studied  34 patients and we identified 28 different mutations that included: 13  missense, five nonsense, three microdeletions, four insertions and three splice  site mutations. All of them were confirmed using genomic DNA. We also studied  dysferlin protein levels by means of Western-blot analysis in CD14+ peripheral  blood monocytes in 25 patients. All of them displayed absence of dysferlin  expression. These results were confirmed in the muscle biopsy by  immunohistochemistry (22/25) and Western blot (15/25). We are currently  developing a new method using cytocentrifuged monocytes and an infrared fluorescence scanner (Odissey, Li-Cor). We  are also developing new antibodies against the extracellular domain of  dysferlin that could be used in flow cytometry analysis.</p>
