            ...
            <td valign="top" align="center"><table width="92%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td valign="top"><p class="section">Relevant Scientific Papers</p>
                    ...
                    <p class="home"> <strong><font color="#0175C2">Drug Screening </font></strong><br>
                          ...
                          <a href="http://www.ncbi.nlm.nih.gov/entrez/query.fcgi?db=pubmed&cmd=Retrieve&dopt=AbstractPlus&list_uids=12951820&query_hl=92&itool=pubmed_docsum" target="_blank"><strong><br>
                       	  ...
                       	  Human cell systems for drug discovery</strong></a><br>

                           	  Horrocks C, Halse R, Suzuki R, Shepherd PR.<br>

                           	  Curr Opin Drug Discov Devel. 2003 Jul;6(4):570-5.<br>

                              <br>

                              <strong><a href="http://www.ncbi.nlm.nih.gov/entrez/query.fcgi?db=pubmed&cmd=Retrieve&dopt=AbstractPlus&list_uids=15287820&query_hl=94&itool=pubmed_docsum" target="_blank">Technological advances in high-throughput screening</a></strong><br>

                              Liu B, Li S, Hu J.<br>

                              Am J Pharmacogenomics. 2004;4(4):263-76.<br>

                              <br>

                              <strong><a href="http://www.ncbi.nlm.nih.gov/entrez/query.fcgi?db=pubmed&cmd=Retrieve&dopt=AbstractPlus&list_uids=16845208&query_hl=93&itool=pubmed_docsum" target="_blank">Introduction to early in vitro identification

                              of metabolites of new chemical entities in drug

                              discovery

                              and development</a></strong><br>

                              Baranczewski P, Stanczak A, Kautiainen A, Sandin

                              P, Edlund PO.<br>

                              Pharmacol Rep. 2006 May-Jun;58(3):341-52.<br>
