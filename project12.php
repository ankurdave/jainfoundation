...
<title>Jain Foundation Inc | Our Funded Projects | Stem Cell Therapy</title>
...
onMouseOut="window.document.sq16.src='images/button_links2.gif'"><img src="images/button_links2.gif" border="0" name="sq16" alt="Helpful Links" width="168" height="32"></a></td>
            ...
            <td valign="top" align="center"><table width="92%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td valign="top"><p class="section">Past Research Projects - Stem Cell Therapy </p>



                    <p class="home"><strong><font color="#0175C2"><span class="style1">Multipotent Adult Progenitor Cells (MAPCs)</span><br>



                    </font></strong>Morayma Reyes, University of Washington (Seattle, WA)
                    ...
                    <br>
                      ...
                      <img src="images/reyes.jpg" width="160" height="140" align="left"><br>

                      <br>                       

                      <strong>                        <a href="http://www.pathology.washington.edu/faculty/facultyinfo.php?facultyID=843">Morayma Reyes, MD, PhD</a> </strong><br>



                        <br>

                        Dr. Reyes is an Assistant Professor in the Department   of Pathology and Laboratory Medicine, University   of Washington (Seattle, WA).<br><br><br><br><br>
