...
$sql=	"UPDATE registrants SET " .
 ...
 // echo $sql;
	...
	?><script language="javascript">window.location="thankyoupolish.php";</script><?
...
onMouseOut="window.document.sq8.src='images/button_faq.gif'"><img src="images/button_faq.gif" border="0" name="sq8" alt="FAQ on LGMD2B/Miyoshi" width="168" height="32"></a></td>
            ...
            <td valign="top" align="center">
				  ...
				  <form name="registrant_3" method="post" action="form3polish.php">
   ...
   <input type="hidden" name="action" value="save">
			...
			<table width="94%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td valign="top"><p class="section">Rejestracja Pacjentow</p>

                    <p class="home"> <strong><font color="#0175C2">Formularz Rejestracyjny</font></strong><br>

                      Prosimy kontynuowac rejestracje; ta czesc jest dodatkowa.<br>

                      <strong> INFORMACJA TU PODANA JEST POUFNA.</strong><br>

                      <br>

                      <strong><font color="#990000">CZESC 3: INFORMACJA O OBJAWACH</font></strong> (informacja dodatkowa)<br>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        ...
                        <td bgcolor="#F3F9FA"><p class="form2"><strong>W jakim wieku zauwazyles/zauwazylas pierwsze symptomy: <input name="age_symptoms" type="text" size="3">
                      ...
                      <tr>
                        ...
                        <td><p class="form2"><strong> Czy uzywasz?<br>

                          a.</strong> 	Wozek inwalidzki/zmotoryzowany wozek invalidzki?

                          <input type="radio" name="scooter" value="always">Zawsze&nbsp;&nbsp;

                          <input type="radio" name="scooter" value="sometimes">Czasami&nbsp;&nbsp;

                          <input type="radio" name="scooter" value="never">Nigdy<br>
                          ...
                          <strong>b</strong>.</strong> 	Laske?

                          <input type="radio" name="cane" value="always">Zawsze&nbsp;&nbsp;

                          <input type="radio" name="cane" value="sometimes">Czasami&nbsp;&nbsp;

                          <input type="radio" name="cane" value="never">Nigdy<br>
                          ...
                          <strong>c.</strong></strong> 	Aparat na nogi?

                          <input type="radio" name="leg_braces" value="always">Zawsze&nbsp;&nbsp;

                          <input type="radio" name="leg_braces" value="sometimes">Czasami&nbsp;&nbsp;

                          <input type="radio" name="leg_braces" value="never">Nigdy<br>
                      ...
                      <tr>
                        ...
                        <td bgcolor="#F3F9FA"><p class="form2"><strong>Jak dalego mozesz chodzic bez pomocy?

                        </strong><br>

									<input type="radio" name="walk_without_assistance" value="not at all">Nie moge chodzic bez pomocy 

						  &nbsp;&nbsp;<input type="radio" name="walk_without_assistance" value="few steps only ">Pare krokow 

                          &nbsp;&nbsp;<input type="radio" name="walk_without_assistance" value="across a room only">Przejsc przez pokoj

						  &nbsp;&nbsp;<br><input type="radio" name="walk_without_assistance" value="a block only">Kilkaset metrow

						  &nbsp;&nbsp;<input type="radio" name="walk_without_assistance" value="a mile or more">Kilometr lub wiecej
                      ...
                      <tr>
                        ...
                        <td><p class="form2"><strong>Ile czasu mozesz stac bez podpory?
                       ...
                       <tr>
                        ...
                        <td bgcolor="#F3F9FA"><p class="form2"><strong>Czy masz trudnosi ze:<br>

                          a.</strong>	Staniem na palcach?
						  ...
						  Nie mam trudnosci<br>

						  &nbsp;&nbsp;&nbsp;&nbsp;W jakim wieku sie te trudnosci zaczely? <input name="tiptoes_age" type="text" size="3">

                          <br>

                          <strong>b</strong>.	Wstawaniem z pozycji siedzacej?
						  ...
						  &nbsp;&nbsp;&nbsp;&nbsp;W jakim wieku sie te trudnosci zaczely? <input name="rising_sitting_position_age" type="text" size="3">

                          <br>

						  &nbsp;&nbsp;&nbsp; Czy uzywasz jakiejs metody do pomocy (n.p. podpieranie sie)? Prosimy opisac.<br>

						  &nbsp;&nbsp;&nbsp;<textarea name="rising_sitting_position_explained" cols="40" rows="4"></textarea>

						  <br>

                          <strong>c.</strong>	Wstawaniem z pozycji lezacej do pozycjii siedzacej (n.p. na luzku)?<br>
						  ...
						  &nbsp;&nbsp;&nbsp;&nbsp;W jakim wieku sie te trudnosci zaczely? <input name="sitting_horizontal_age" type="text" size="3">

                          <br>

						  <strong>d</strong>.	Wchodzeniem po schodach bez pomocy lub poreczy?<br> 
						  ...
						  &nbsp;&nbsp;&nbsp;&nbsp;W jakim wieku sie te trudnosci zaczely? <input name="climbing_stairs_age" type="text" size="3">

                          <br>

						  &nbsp;&nbsp;&nbsp;&nbsp;Czy mozesz wejsc po schodach z pomoca (n.p. poreczy lub laski)? Prosimy opisac.<br>

						  &nbsp;&nbsp;&nbsp;<textarea name="climbing_stairs_explained" cols="40" rows="4"></textarea>

						  <br>

						  <strong>e.</strong>	Wchodzeniem pod gore (n.p. po rampie)?     
						  ...
						  &nbsp;&nbsp;&nbsp;&nbsp; W jakim wieku sie te trudnosci zaczely? <input name="elevation_age" type="text" size="3">

                          <br>

						  <strong>f.</strong>	Z podnoszeniem rak w gore?    
						 ...
						 Tak, mam trudnosci
						  ...
						  &nbsp;&nbsp;&nbsp;&nbsp; W jakim wieku sie te trudnosci zaczely? <input name="raising_arm_above_head_age" type="text" size="3">

                          <br>

                          <strong>g.</strong>	Podnoszeniem szklanki wody?     
						  ...
						  &nbsp;&nbsp;&nbsp;&nbsp; W jakim wieku sie te trudnosci zaczely? <input name="glass_of_water_age" type="text" size="3">

                          <br>

						  <strong>h.</strong>	Otwieraniem sloikow?     
						 ...
						 Nie mam trudnosci <br>
						  ...
						  &nbsp;&nbsp;&nbsp;&nbsp; W jakim wieku sie te trudnosci zaczely? <input name="opening_jar_age" type="text" size="3">

                          <br>

						  <strong>i.</strong>	Niesieniem trzech litrow mleka poprzez pokoj?     
						 ...
						 Nie mam trudnosci <br>
						  ...
						  &nbsp;&nbsp;&nbsp;&nbsp; W jakim wieku sie te trudnosci zaczely? <input name="carrying_milk_age" type="text" size="3">

                          <br>

						  <strong>j.</strong>	Kreceniem kierownica?     
						 ...
						 Nie mam trudnosci <br>
						  ...
						  &nbsp;&nbsp;&nbsp;&nbsp; W jakim wieku sie te trudnosci zaczely? <input name="turning_car_wheel_age" type="text" size="3">
						 ...
						 Nie mam trudnosci <br>
						  ...
						  &nbsp;&nbsp;&nbsp;&nbsp; W jakim wieku sie te trudnosci zaczely? <input name="typing_age" type="text" size="3">
                      ...
                      <tr>
                        ...
                        <td><p class="form2"><strong>Czy masz klopoty sercowe lub oddechowe?</strong> Prosimy wyjasnic.<strong><br>
                     ...
                     <tr>
                        ...
                        <td bgcolor="#F3F9FA"><p class="form3"><strong>Czy zauwazyles/zauwazylas jakie czynniki (n.p. cwiczenia, djeta, alkohol) nasilaja lub polepszaja objawy?</strong> Prosimy wyjasnic.<strong><br>
					  ...
					  <tr>
                        ...
                        <td><p class="form3"><strong>Czy czesto brales/bralas udzial w sportach lub wysilkach fizycznych zanim objawy sie zaczely? </strong>Prosimy wyjasnic.<strong><br>
					  ...
					  <tr>
                        ...
                        <td bgcolor="#F3F9FA"><p class="form3"><strong> Czy masz inne choroby neurologiczne lub autoimmunologiczne, lub cukrzyce?</strong><strong> </strong>Prosimy wyjasnic.<strong><br>
                      ...
                      <tr>
                        ...
                        <td align="center" height="40"><input type="submit" name="Submit" value="Zlozyc">&nbsp;&nbsp;&nbsp;

                          <input name="Reset" type="reset" id="Reset" value="Wymazac"></td>
