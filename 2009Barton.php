...
<span class="home"></span><br><br>
				...
				<p><span class="style10">POSTER ABSTRACTS </span><br>
				  ...
				  <br>
				  <a href="2009Bartoli.php" class="style18">Previous</a>&nbsp;&nbsp;<a href="2009Blank.php" class="style18">Next</a>&nbsp;&nbsp;
				
				  <br>
				  <br>

                  <strong><span class="style17">Elisabeth Barton, PhD</span></strong><br>

                  <em>University of Pennsylvania, Philadelphia, PA</em><br><br>

                  <img src="images/Conf09/Barton.jpg" width="135"><br><br><br>

                  <strong>Development of Functional Outcome Measures for Mouse Models of Dysferlin
Deficiency</strong><br>

Elisabeth Barton<br><br>

The mouse models for dysferlin deficiency recapitulate the primary membrane-resealing
defect in muscle. However, the disease progresses slowly, lengthening the time for
evaluating any potential therapies. Histologic characterization has shown that the abdominal
muscles of the A/J mouse provide the most severe pathology, yet this muscle (the rectus
abdominus) is difficult to be utilized for functional measurements due to its fiber
geometry/architecture. To provide a solid basis for evaluating any potential therapies in
terms of force generating capacity, we have defined a functional signature for the skeletal
muscles in the A/J mouse, specifically the extensor digitorum longus (EDL), soleus, and the
diaphragm. We have found that the A/J diaphragm exhibits significant and progressive
weakness and susceptibility to contractile injury. To determine if severity of functional
impairment is correlated to the amount of endogenous dysferlin in normal mouse muscles, immunoblotting was
performed to measure dysferlin content in a variety of muscles. There was no correlation between severity of functional
impairment and dysferlin content. We are now in the process of fiber type analysis for these muscles to determine if fiber
type has any correlation to the level of dysferlin, or to the susceptibility of eccentric contraction-induced membrane
damage. </p>
