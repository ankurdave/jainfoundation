...
Click here to download a <a href="downloads/summary2009.pdf" class="style14" target="_blank">pdf version</a> of the full conference summary.<br><br>

                      <br>

  <a href="2009sci_summary_s1.php" class="style14">Session I: Dysferlinopathy - Mechanisms of Pathology I</a><br>

  <a href="2009sci_summary_s2.php" class="style14">Session II: Dysferlinopathy - Mechanisms of Pathology II</a><br>

  <a href="2009sci_summary_s3.php" class="style14">Session III: Dysferlin Structure and Function</a> <br>

  <a href="2009sci_summary_s4.php" class="style14">Session IV: Membrane Fusion and Repair</a><br>

  <a href="2009sci_summary_s5.php" class="style14">Session V: Muscle Satellite Cells</a><br>

  <a href="2009sci_summary_s6.php" class="style14">Session VI: Stem Cell Therapy</a><br>

  <a href="2009sci_summary_s7.php" class="style14">Session VII: Emerging Therapies for Dysferlinopathy</a><br>
  
  <a href="2009sci_summary_s8.php" class="style14">Session VIII: Lessons from the Clinic – Clues to a Cure</a><br>
  
  <a href="2009sci_summary_s9.php" class="style14">Session IX: Clues from Other Ferlins and Myopathies</a><br>
  
  <a href="2009sci_summary_s10.php" class="style14">Session X: New Tools for Studying Dysferlin</a>
   </p>
