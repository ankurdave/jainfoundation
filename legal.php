<html>
<head>
<title>Jain Foundation Inc | Legal Disclaimer</title>
...
onMouseOut="window.document.sq16.src='images/button_links2.gif'"><img src="images/button_links2.gif" border="0" name="sq16" alt="Helpful Links" width="168" height="32"></a></td>
            ...
            <td valign="top" align="center"><table width="92%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td><p class="section style3">Legal Disclaimer </p>
                  <p><strong><span class="home"><br>
                    </span></strong>The Jain Foundation values   your trust and respects your privacy.&nbsp; We will only collect personal   information if it is voluntarily provided through the registration process   or through other contact with the Jain Foundation. We use this   information for research purposes and do not disclose any individually-identifiable   information without your specific consent. If you provide your   contact information, we may be in touch with you in the future regarding   research findings, educational symposia, clinical trial opportunities   and related news. We will not sell your personal information under   any circumstance. There may be situations when we are required   by law or legal process to disclose information that you provide to   us.<br>
                    <br>
                    Material presented on this   website is for informational purposes only, and the Jain Foundation   makes no representations, warranties or assurances as to the accuracy,   currency or completeness of the content provided, including third party   information.<br>
                    <br>
                    Information on this website   should not be used for diagnostic or treatment purposes. Information   obtained on this website does not substitute for consulting a physician   or healthcare provider knowledgeable about LGMD2B/Miyoshi.<br>
