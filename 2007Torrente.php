...
<span class="home"></span><br><br>
				...
				<p><span class="style10">SPEAKER ABSTRACTS </span><br><br><br>
				  ...
				  <strong><span class="style17">Yvan Torrente, MD, PhD

				  </span><br>

				  </strong><em>Stem Cell Laboratory, Department of Neurological  Science, Fondazione IRCCS Ospedale Maggiore Policlinico, Centro Dino Ferrari,  University of Milan, Italy</em><strong><br>

                  </strong> <span class="style10"><br>

                  <img src="images/conference/3-Torrente.jpg" width="135">                  <br>

                  <br>

                  <br>

                  <strong>Myogenic potential of CD133+ cells</strong></span><br>

                  <br>

                  Stem cell use involves the delivery of normal cells to dystrophic muscle with the hope  that the delivered cells will repopulate the dystrophic tissue. Although  myoblast cells retain the main myogenic activity in adult muscle, they lack the  ability to migrate through the muscle and cross vessels when delivered  systematically, and they have a high mortality after intramuscular injection.  The demonstration that other progenitors can differentiate into skeletal muscle  created an alternative possibility for cell-based therapies. Human  blood-derived progenitors, expressing the CD133 marker, are able to efficiently  fuse with dystrophic muscle fibers, thus participating in the muscle regeneration  process. We previously investigated a combined stem cell and exon skipping  approach in Duchenne muscular dystrophy (DMD), an x-linked inherited pathology  caused by mutations in the gene coding for the dystrophin protein, most  frequently (more than 70%) due to deletions that create a frame-shift along the  transcript sequence; thus, the use of exon skipping

methods seems to be very promising in this disease. We  evaluated the muscle regeneration potentiality of two DMD myogenic progenitors,  isolated for their expression of CD133 antigen from the blood and muscle, after <em>in vitro</em> exon skipping treatment. The  skipped DMD cells were able to fuse with scid/mdx mouse muscle fibers and  largely expressed human dystrophin. These data consolidated the idea of using a  stem cell therapy approach for muscular dystrophies and open the possibility that  transplantation of autologous engineered blood or muscle CD133 + stem cells  could represent a future treatment for other muscular dystrophies, like  dysferlinopathies: Miyoshi myopathy (MM) and Limb-Girdle Muscular Dystrophy  type 2B (LGMD type 2B).</p>
