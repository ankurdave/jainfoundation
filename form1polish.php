...
?><script language="javascript">window.location="form2polish.php";</script><?
...
onMouseOut="window.document.sq16.src='images/button_links2.gif'"><img src="images/button_links2.gif" border="0" name="sq16" alt="Helpful Links" width="168" height="32"></a></td>
            ...
            <td valign="top" align="center">
			  ...
			  <form name="registrant_1" method="post" action="form1polish.php" onSubmit="return validate();">
              ...
              <tr>
                ...
                <td valign="top"><p class="section">Rejestracja Pacjentow</p>
                    ...
                    <p class="home"> <strong><font color="#0175C2">Formularz Rejestracyjny</font></strong><br>
                          ...
                          Ten formularz rejestracyjny ma 3 czesci i wypelnienie go zabierze okolo 15 minut.  Twoje odpowiedzi pomoga w analizie stanu zaawansowania tej choroby i wielu innych cech dystrofi miesniowej LGMD.  Prosimy of wypelnienie calego formularza, wlacznie z pytaniami dodatkowymi.  Ta witryna WWW jest bezpieczna i strzezona przez szyfr SSL.   <strong>INFORMACJA TU PODANA JEST POUFNA </strong>.<br>

                      <br>

Jezeli nie chcesz sie zarejestrowac na naszej witrynie WWW, prosimy sie skontaktowac z Dr. Plavi Mittal at <a href="mailto:plavimittal@jain-foundation.org">plavimittal@jain-foundation.org</a> <br>
...
<strong><font color="#990000">CZESC PIERWSZA: INFORMACJA PODSTAWOWA</font></strong><br><br>
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
                      ...
                      <tr bgcolor="#F3F9FA">
                        ...
                        <td width="30%"><p class="form">Imie </p></td>
                      ...
                      <tr>
                       ...
                       <td><p class="form">Numer telefonu (informacja dodatkowa)</p></td>
                      ...
                      <tr bgcolor="#F3F9FA">
                        ...
                        <td><p class="form"> Adres (informacja dodatkowa)</p></td>
                      ...
                      <tr>
                        ...
                        <td><p class="form">Miasto/ Kod pocztowy</p></td>
					  ...
					  <tr bgcolor="#F3F9FA">
                        ...
                        <td width="30%"><p class="form">Kraj</p></td>
                      ...
                      <tr bgcolor="#F3F9FA">
                       ...
                       <td bgcolor="#F3F9FA"><p class="form">Wiek</p></td>
                      ...
                      <tr>
                       ...
                       <td><p class="form">Wiek w czasie diagnozy</p></td>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        ...
                        <td bgcolor="#F3F9FA"><p class="form2"><strong> Czy diagnoza byla potwierdzona:<br>

                          a.</strong>	Badaniem fizycznym? 

                          <input type="radio" name="diagnosis_examination" value="Yes">Tak 

						  &nbsp;&nbsp;<input type="radio" name="diagnosis_examination" value="No">Nie 

                          &nbsp;&nbsp;<input type="radio" name="diagnosis_examination" value="Not Sure"> 

                          Nie jestem pewien/pewna                          <br>

                          <strong>b</strong>.	Poziom CK (kinazy creatyny)? 

                          <input type="radio" name="diagnosis_CK_level" value="Yes">Tak 

						  &nbsp;&nbsp;<input type="radio" name="diagnosis_CK_level" value="No">Nie 
                          ...
                          Jaki byl poziom kinazy creatyny w czasie diagnozy (jesli znany)? 

                          <input name="diagnosis_CK_level_number" type="text" size="3" maxlength="8">

                          <br>

                          <strong>c.</strong>	Biopsja miesni? <input type="radio" name="diagonsis_muscle_biopsy" value="Yes">Tak 

						  &nbsp;&nbsp;<input type="radio" name="diagonsis_muscle_biopsy" value="No">Nie 

                          &nbsp;&nbsp;<input type="radio" name="diagonsis_muscle_biopsy" value="Not Sure"> Nie jestem pewien/pewna <br>

                          <strong>d.</strong>	Analiza krwi (monocytow)? 

                          <input type="radio" name="diagnosis_blood_cell_test" value="Yes">Tak 

						  &nbsp;&nbsp;<input type="radio" name="diagnosis_blood_cell_test" value="No">Nie 

                          &nbsp;&nbsp;<input type="radio" name="diagnosis_blood_cell_test" value="Not Sure"> Nie jestem pewien/pewna <br>

                          <strong>e.</strong>	Analiza mutacji (sekwencja DNA)? 

                          <input type="radio" name="diagnosis_mutational" value="Yes">Tak 

						  &nbsp;&nbsp;<input type="radio" name="diagnosis_mutational" value="No">Nie 

                          &nbsp;&nbsp;<input type="radio" name="diagnosis_mutational" value="Not Sure"> Nie jestem pewien/pewna </p></td>

                      </tr>

                      <tr>

                        <td><p class="form2"><strong>Data wypelnienia <input name="submission_date" type="text" value="<?=$myDate;?>" size="10" maxlength="50">
