...
Chaperones are small molecules or proteins that can bind to and stabilize the normal 3-dimensional shape of proteins such as dysferlin, so that missense mutants are more likely to fold correctly instead of misfolding. <i>This strategy is currently in clinical trials for cystic fibrosis but is still in development for dysferlin deficiency.</i><br><br>We are funding one project to help develop this strategy:<br>&nbsp;&nbsp;&nbsp;&nbsp;- Simone Spuler, CharitŽ, University Medicine Berlin, Germany
