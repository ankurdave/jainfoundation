...
$sql=	"UPDATE registrants SET " .
  ...
  //echo $sql;
	...
	?><script language="javascript">window.location="form3italian.php";</script><?
...
onMouseOut="window.document.sq8.src='images/button_faq.gif'"><img src="images/button_faq.gif" border="0" name="sq8" alt="FAQ on LGMD2B/Miyoshi" width="168" height="32"></a></td>
            ...
            <td valign="top" align="center">
				  ...
				  <form name="registrant_2" method="post" action="form2italian.php" onSubmit="validate();">
              ...
              <tr>
                ...
                <td valign="top"><p class="section">Registrazione Pazienti</p>
                    ...
                    <p class="home"> <strong><font color="#0175C2">Form di Registrazione</font></strong><br>
                     ...
                     Continua con la registrazione; questa parte è comunque facoltativa.<br>

       <strong>TUTTE LE TUE INFORMAZIONI SARANNO TENUTE RISERVATE.</strong><br>

<br>

<strong><font color="#990000">PARTE 2: BACKGROUND FAMIGLIARE</font></strong> (facoltativo)<br>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        ...
                        <td bgcolor="#F3F9FA"><p class="form2"><strong>Hai altri famigliari con la tua stessa patologia?</strong><strong><br>

                          Madre</strong>

                            <input type="radio" name="mom_disease" value="Yes">Si 
                          ...
                          <input type="radio" name="dad_disease" value="Yes">Si 
					  ...
					  <tr>
                        ...
                        <td><p class="form2"><strong>Hai fratelli/sorelle?</strong><br>

                          Nome <input name="sibling_name1" type="text" size="18">

                          &nbsp;&nbsp;Età <input name="sibling_age1" type="text" size="3">

                          &nbsp;&nbsp;Affetto da LGMD2B? <input type="radio" name="sibling_LGMD2B1" value="Yes">Si

						  &nbsp;&nbsp;<input type="radio" name="sibling_LGMD2B1" value="No">No<br>

						 Nome <input name="sibling_name2" type="text" size="18">

                          &nbsp;&nbsp;Età <input name="sibling_age2" type="text" size="3">

                          &nbsp;&nbsp;Affetto da LGMD2B? <input type="radio" name="sibling_LGMD2B2" value="Yes">Si

						  &nbsp;&nbsp;<input type="radio" name="sibling_LGMD2B2" value="No">No<br>

							   Nome <input name="sibling_name3" type="text" size="18">

                          &nbsp;&nbsp;Età <input name="sibling_age3" type="text" size="3">

                          &nbsp;&nbsp;Affetto da LGMD2B? <input type="radio" name="sibling_LGMD2B3" value="Yes">Si

						  &nbsp;&nbsp;<input type="radio" name="sibling_LGMD2B3" value="No">No<br>

						 Nome <input name="sibling_name4" type="text" size="18">

                          &nbsp;&nbsp;Età <input name="sibling_age4" type="text" size="3">

                          &nbsp;&nbsp;Affetto da LGMD2B? <input type="radio" name="sibling_LGMD2B4" value="Yes">Si
					  ...
					  <tr>
                        ...
                        <td bgcolor="#F3F9FA"><p class="form2"><strong>Hai figli?</strong><br>

                          Nome <input name="children_name1" type="text" size="18">

                          &nbsp;&nbsp;Età <input name="children_age1" type="text" size="3">

                          &nbsp;&nbsp;Affetto da LGMD2B? <input type="radio" name="children_LGMD2B1" value="Yes">Si

						  &nbsp;&nbsp;<input type="radio" name="children_LGMD2B1" value="No">No<br>

						 Nome <input name="children_name2" type="text" size="18">

                          &nbsp;&nbsp;Età <input name="children_age2" type="text" size="3">

                          &nbsp;&nbsp;Affetto da LGMD2B? <input type="radio" name="children_LGMD2B2" value="Yes">Si

						  &nbsp;&nbsp;<input type="radio" name="children_LGMD2B2" value="No">No<br>

							  Nome <input name="children_name3" type="text" size="18">

                          &nbsp;&nbsp;Età <input name="children_age3" type="text" size="3">

                          &nbsp;&nbsp;Affetto da LGMD2B? <input type="radio" name="children_LGMD2B3" value="Yes">Si

						  &nbsp;&nbsp;<input type="radio" name="children_LGMD2B3" value="No">No<br>

						 Nome <input name="children_name4" type="text" size="18">

                          &nbsp;&nbsp;Età <input name="children_age4" type="text" size="3">

                          &nbsp;&nbsp;Affetto da LGMD2B? <input type="radio" name="children_LGMD2B4" value="Yes">Si
					  ...
					  <tr>
                        ...
                        <td><p class="form2"><strong>Hai altri parenti con questa malattia?</strong><br>

                          Nome <input name="relatives_name1" type="text" size="18">

                          &nbsp;&nbsp;Età <input name="relatives_age1" type="text" size="3">

                          &nbsp;&nbsp;Affetto da LGMD2B? <input type="radio" name="relatives_LGMD2B1" value="Yes">Si

						  &nbsp;&nbsp;<input type="radio" name="relatives_LGMD2B1" value="No">No<br>

						 Nome <input name="relatives_name2" type="text" size="18">

                          &nbsp;&nbsp;Età <input name="relatives_age2" type="text" size="3">

                          &nbsp;&nbsp;Affetto da LGMD2B? <input type="radio" name="relatives_LGMD2B2" value="Yes">Si

						  &nbsp;&nbsp;<input type="radio" name="relatives_LGMD2B2" value="No">No<br>

							   Nome <input name="relatives_name3" type="text" size="18">

                          &nbsp;&nbsp;Età <input name="relatives_age3" type="text" size="3">

                          &nbsp;&nbsp;Affetto da LGMD2B? <input type="radio" name="relatives_LGMD2B3" value="Yes">Si

						  &nbsp;&nbsp;<input type="radio" name="relatives_LGMD2B3" value="No">No<br>

						  Nome <input name="relatives_name4" type="text" size="18">

                          &nbsp;&nbsp;Età <input name="relatives_age4" type="text" size="3">

                          &nbsp;&nbsp;Affetto da LGMD2B? <input type="radio" name="relatives_LGMD2B4" value="Yes">Si
                      ...
                      <tr>
                        ...
                        <td align="center" height="40"><input name="Continue" type="submit" id="Continue" value="Continua">&nbsp;&nbsp;&nbsp;
