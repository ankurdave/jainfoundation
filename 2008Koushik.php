...
<span class="home"></span><br><br>
				...
				<p><span class="style10">POSTER ABSTRACTS </span><br>
				  ...
				  <br>
				  <a href="2008Lostal.php" class="style18">Next</a>&nbsp;&nbsp;
				<a href="2008Jaiswal.php" class="style18">Previous</a>
                 ...
                 <strong><span class="style17">Srinagesh V. Koushik, PhD</span></strong><br>
                  ...
                  <em>Laboratory of Dr. Steven Vogel, NIAAA, National Institutes of Health</em><br><br>

                  <img src="images/conference2008/Koushik.jpg" width="135"><br><br><br>

                  <strong>Using Morpholinos to Probe the Function of Dysferlin in Developing Sea Urchin Embryos</strong><strong>&nbsp; &nbsp;</strong><br>

Srinagesh V. Koushik and Steven S. Vogel<br><br>

 Mutations in dysferlin inhibit wound healing in mice, membrane fusion in C. elegans and cell division in D. melanogaster, however, the mechanism through which the protein mediates these cellular processes is unknown.  Due to their size and ease of use, sea urchin embryos are ideal for examining wound healing, endocytosis, exocytosis and cell division and was therefore used in this study.  We identified and cloned cDNA encoding the 5’ end of sea urchin dysferlin using 5’RACE and designed an antisense morpholino to inhibit gene expression during embryonic development.  Preliminary results indicate that the antisense morpholino inhibits wound healing, exocytosis, endocytosis and cell division in developing embryos, suggesting that the function of sea urchin dysferlin is similar to that of higher organisms.
                </p>
