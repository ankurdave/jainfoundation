...
$sql=	"UPDATE registrants SET " .
  ...
  //echo $sql;
	...
	?><script language="javascript">window.location="form3german.php";</script><?
...
onMouseOut="window.document.sq8.src='images/button_faq.gif'"><img src="images/button_faq.gif" border="0" name="sq8" alt="FAQ on LGMD2B/Miyoshi" width="168" height="32"></a></td>
            ...
            <td valign="top" align="center">
				  ...
				  <form name="registrant_2" method="post" action="form2german.php" onSubmit="validate();">
...
<strong><font color="#990000">TEIL 2: FAMILIENANAMNESE</font></strong> (freiwillig)<br>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        ...
                        <td bgcolor="#F3F9FA"><p class="form2"><strong>Sind ihre eltern an LGMD2B erkrankt?</strong><strong><br>
					  ...
					  <tr>
                        ...
                        <td><p class="form2"><strong>Haben Sie Geschwister mit den selben Eltern?</strong><br>

                          Name <input name="sibling_name1" type="text" size="18">

                          &nbsp;&nbsp;Alter <input name="sibling_age1" type="text" size="3">

                          &nbsp;&nbsp;Erkrankt an LGMD2B? 

                          <input type="radio" name="sibling_LGMD2B1" value="Yes">Ja
						 ...
						 Name <input name="sibling_name2" type="text" size="18">
                          ...
                          &nbsp;&nbsp;Alter <input name="sibling_age2" type="text" size="3">

                          &nbsp;&nbsp;Erkrankt an LGMD2B? <input type="radio" name="sibling_LGMD2B2" value="Yes">Ja
                          ...
                          &nbsp;&nbsp;Alter <input name="sibling_age3" type="text" size="3">

                          &nbsp;&nbsp;Erkrankt an LGMD2B? <input type="radio" name="sibling_LGMD2B3" value="Yes">Ja
                          ...
                          &nbsp;&nbsp;Alter <input name="sibling_age4" type="text" size="3">

                          &nbsp;&nbsp;Erkrankt an LGMD2B? <input type="radio" name="sibling_LGMD2B4" value="Yes">Ja
					  ...
					  <tr>
                        ...
                        <td bgcolor="#F3F9FA"><p class="form2"><strong>Haben Sie Kinder?</strong><br>

                          Name <input name="children_name1" type="text" size="18">

                          &nbsp;&nbsp;Alter <input name="children_age1" type="text" size="3">

                          &nbsp;&nbsp;Erkrankt an LGMD2B? <input type="radio" name="children_LGMD2B1" value="Yes">Ja
						...
						Name <input name="children_name2" type="text" size="18">
                          ...
                          &nbsp;&nbsp;Alter <input name="children_age2" type="text" size="3">

                          &nbsp;&nbsp;Erkrankt an LGMD2B? <input type="radio" name="children_LGMD2B2" value="Yes">Ja
                          ...
                          &nbsp;&nbsp;Alter <input name="children_age3" type="text" size="3">

                          &nbsp;&nbsp;Erkrankt an LGMD2B? <input type="radio" name="children_LGMD2B3" value="Yes">Ja
                          ...
                          &nbsp;&nbsp;Alter <input name="children_age4" type="text" size="3">

                          &nbsp;&nbsp;Erkrankt an LGMD2B? <input type="radio" name="children_LGMD2B4" value="Yes">Ja
					  ...
					  <tr>
                        ...
                        <td><p class="form2"><strong>Haben andre Verwandte oder Vorfahren LGMD2B?</strong><br>

                          Name <input name="relatives_name1" type="text" size="18">

                          &nbsp;&nbsp;Alter <input name="relatives_age1" type="text" size="3">

                          &nbsp;&nbsp;Erkrankt an LGMD2B? <input type="radio" name="relatives_LGMD2B1" value="Yes">Ja
						 ...
						 Name <input name="relatives_name2" type="text" size="18">
                          ...
                          &nbsp;&nbsp;Alter <input name="relatives_age2" type="text" size="3">

                          &nbsp;&nbsp;Erkrankt an LGMD2B? <input type="radio" name="relatives_LGMD2B2" value="Yes">Ja
                          ...
                          &nbsp;&nbsp;Alter <input name="relatives_age3" type="text" size="3">

                          &nbsp;&nbsp;Erkrankt an LGMD2B? <input type="radio" name="relatives_LGMD2B3" value="Yes">Ja
                          ...
                          &nbsp;&nbsp;Alter <input name="relatives_age4" type="text" size="3">

                          &nbsp;&nbsp;Erkrankt an LGMD2B? <input type="radio" name="relatives_LGMD2B4" value="Yes">Ja
