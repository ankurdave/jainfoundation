<html>
<head>
<title>Jain Foundation Inc | Research Database | Mouse models | Control strains</title>
            ...
            <td valign="top" align="center"><table width="92%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td><p class="section style3">Research Database</p>
                      ...
                      <p><strong>What are the suitable control strains for the Dysferlin deficient mouse models?</strong></p>
                     
					  <p><strong>C57BL/10.SJL-Dysf</strong>: C57BL/10</p>
				  <p><strong>Dysf-/- (B6.129-Dysf<sup>tm1Kcam</sup>/Mmmh)</strong>: C57BL/6 (for homozygotes); littermates (for heterozygotes)</p>
                      <p><strong>A/J</strong>: A/HeJ, A/WySnJ</p>
