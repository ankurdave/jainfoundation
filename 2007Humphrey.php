...
<span class="home"></span><br><br>
				...
				<p><span class="style10">POSTER ABSTRACTS </span><br>
                  ...
                  <em>Laboratory of Dr. Joshua Zimmerberg</em><br>

                  <br>

                  <img src="images/conference/54-Humphrey.jpg" width="135">                  <br><br><br>

                  <strong>Identification of S. purpuratus yolk granule  tethering factor</strong> <br>

Glen W. Humphrey, Paul L. McNeil, Anna  McNeil, and Joshua Zimmerberg</p>

                <p>In echinoderm eggs,  plasma membrane disruptions can be repaired through a calcium-activated fusion  pathway. Cytoplasmic yolk granules (YGs) undergo homotypic fusion to form large  &ldquo;patch vesicles&rdquo; which repair the membrane through fusion at the site of the  disruption. A multisubunit protein complex (670 kDa), termed &ldquo;tethering factor&rdquo;  (TF), was identified in the starfish, Asterias forbesi, which promotes  aggregation of YGs, a prerequisite for homotypic fusion (J. Cell Sci. 2005,  118:4701). We have detected YG tethering activity in eggs of the sea urchin,  Strongylocentrotus purpuratus. We plan to take advantage of the sequenced  genome of S. purpuratus to identify the protein components of the TF complex. A  monoclonal antibody raised to the 170 kDa subunit of the Aserias TF  cross-reacts with a 170 kDa protein eluted from S. purpuratus YGs by 470 mM KI.  The cross-reacting protein fractionates in Q<br>

                  Sepharose  chromatography similar to the Asterias TF, suggesting that a homologous complex  exists in S. purpuratus. Work is in progress to obtain a sufficient quantity of  S. purpuratus TF complex for protein identification using mass spectrometry.</p>
